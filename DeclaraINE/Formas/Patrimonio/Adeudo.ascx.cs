    ...
    public partial class Adeudo : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                cmbNID_INSTITUCION.DataBinder<blld__l_CAT_INST_FINANCIERA>(new blld__l_CAT_INST_FINANCIERA(), CAT_INST_FINANCIERA.Properties.NID_INSTITUCION, CAT_INST_FINANCIERA.Properties.V_INSTITUCION, false);
