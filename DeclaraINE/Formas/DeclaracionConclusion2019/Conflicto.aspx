<%@ Page Title="" Language="C#" MasterPageFile="~/Formas/DeclaracionConclusion/_Conclusion.master" AutoEventWireup="true" CodeBehind="Conflicto.aspx.cs" Inherits="DeclaraINE.Formas.DeclaracionConclusion.Conflicto" Culture="es-MX" UICulture="es-MX" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ChildContent2" runat="server">
    ...
    <div class="subtitulo">
        <asp:Literal ID="ltrSubTitulo" runat="server" Text="Declaración de Intereses"></asp:Literal>
    </div>
    <div id="cuerpo">
        <label>
        ...
        <asp:GridView ID="grdRubros" runat="server" AutoGenerateColumns="false" CssClass="table table-striped borderless table-dark" OnRowDataBound="grdRubros_RowDataBound">
            <Columns>
                <asp:TemplateField HeaderText="En este sentido:">
                    <ItemTemplate>
                        ...
                        <br />
                        <asp:Button ID="btnAgregarEncabezado" runat="server" Text="Agregar " OnClick="btnSI_Click" CommandArgument='<%# Eval("NID_RUBRO") %>' />
                        <br />
                        <br />
    ...
    <asp:AlanModalPopUp runat="server" ID="mppPreguntas" HeaderText="Información Adicional">
        <ContentTemplate>
            <table class="f">
                <tr>
                    <td>¿Esta relación le genera o puede ser susceptible de un conflicto de intereses con relación a su cargo público?    
