<%@ Page Title="" Language="C#" MasterPageFile="~/Formas/DeclaracionInicial/_Inicial.master" AutoEventWireup="true" CodeBehind="Desemp.aspx.cs" Inherits="DeclaraINE.Formas.DeclaracionInicial.Desemp" %>
        ...
        <table class="f">
         ...
         <asp:GridView ID="grdPreguntas" CssClass="table-striped table-condensed borderless" runat="server" AutoGenerateColumns="false" ShowHeader="false" OnRowDataBound="grdPreguntas_RowDataBound">
            ...
            <table class="f">
                <tr>
                    <th>
                        <l>Aclaraciones/Observaciones (máximo permitidos: 2000)
                            <asp:TextBox ID="txtcuenta"  runat="server" BackColor="#EEEEEE" ReadOnly="True"></asp:TextBox> </l>
