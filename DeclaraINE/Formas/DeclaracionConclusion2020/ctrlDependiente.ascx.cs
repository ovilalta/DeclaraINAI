    ...
    public partial class ctrlDependiente : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                oDep.select();
                cmbNID_TIPO_DEPENDIENTE_DEP.DataBind(oDep.lista_CAT_TIPO_DEPENDIENTES, CAT_TIPO_DEPENDIENTES.Properties.NID_TIPO_DEPENDIENTE, CAT_TIPO_DEPENDIENTES.Properties.V_TIPO_DEPENDIENTE);
        ...
        public void llena(blld_DECLARACION_DEPENDIENTES Dependiente, Int32 Id)
        {
            ...
            //try { txtV_DOMICILIO_LABORAL.Text = oDomicilio.V_DOMICILIO.Split('|')[0]; } catch { }
            //try { txtNumExteriorDOMICILIO_LABORAL.Text = oDomicilio.V_DOMICILIO.Split('|')[1]; } catch { }
            //try { txtNumInteriorDOMICILIO_LABORAL.Text = oDomicilio.V_DOMICILIO.Split('|')[2]; } catch { }
        ...
        protected void cmbNID_TIPO_DEPENDIENTE_DEP_SelectedIndexChanged(object sender, EventArgs e)
        {
            //if ((new String[] { "3", "4", "5" }).Contains(cmbNID_TIPO_DEPENDIENTE_DEP.SelectedValue))
            //{
            //    trDepende1.Visible = true;
            //    //trDepende2.Visible = true;
            //}
