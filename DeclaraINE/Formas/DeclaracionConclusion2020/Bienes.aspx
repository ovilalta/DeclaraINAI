        ...
        <ContentTemplate>
            <table class="f">
                <tbody>
                    ...
                    <td>
                        <asp:TextBox ID="txtTipoMonedaMueble" runat="server" requerido="btnGuardarMueble" MaxLength="128"></asp:TextBox>
                    </td>
                </tr>
        ...
        <ContentTemplate>
            <table class="f">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtTipoMonedaVehiculo" runat="server" requerido="btnGuardarVehiculo" MaxLength="128"></asp:TextBox>
                    </td>
                </tr>
               <tr>
                    <th>
                ...
                <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="cmbPaisVehiculo" runat="server" CssClass="n3" OnSelectedIndexChanged="cmbPaisVehiculo_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
