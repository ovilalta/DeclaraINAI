        ...
        protected void OnEditar(object sender, ItemEventArgs e)
        {
            ...
            switch (SubSeccionActiva)
            {
                case SubSecciones.BienesInmuebles:
                    ...
                    txtNombreTransmisor.Text = i.E_NOMBRE_TRANSMISOR.ToString().Split('|')[0];
                    cmbInmuMotivoBajaInmu.SelectedValue = i.E_NOMBRE_TRANSMISOR.ToString().Split('|')[1];
                ...
                case SubSecciones.OtrosBienes:
                    ...
                    txtNombreTransmisorMueble.Text = m.E_NOMBRE_TRANSMISOR.ToString().Split('|')[0];
                    cmbMotivoBaja.SelectedValue = m.E_NOMBRE_TRANSMISOR.ToString().Split('|')[1];
                ...
                case SubSecciones.Vehiculos:
                    ...
                    txtNombreTransmisorVehiculo.Text = v.E_NOMBRE_TRANSMISOR.ToString().Split('|')[0];
                    cmbVehiMotivoBaja.SelectedValue = v.E_NOMBRE_TRANSMISOR.ToString().Split('|')[1];
        ...
        private void GuardarMueble()
        {
            ...
            try
            {
                oDeclaracion.ALTA.Add_ALTA_MUEBLEs(
                                                ...
                                                , Convert.ToInt32(cmbRelacionTransmisorMueble.SelectedValue)
