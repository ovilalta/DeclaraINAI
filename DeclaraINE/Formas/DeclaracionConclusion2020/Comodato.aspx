<%@ Page Title="" Language="C#" MasterPageFile="~/Formas/DeclaracionInicial/_Inicial.master" AutoEventWireup="true" CodeBehind="Comodato.aspx.cs" Inherits="DeclaraINE.Formas.DeclaracionInicial.Comodato" %>
        ...
        <ContentTemplate>
            <table class="f">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="cmbNID_TIPO_RELACION" runat="server"  requerido="btnGuardarComodo" AutoPostBack="true"  OnSelectedIndexChanged="cmbNID_TIPO_RELACION_SelectedIndexChanged" ></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <th>
