...
namespace DeclaraINE.Formas.DeclaracionInicial
{
    public partial class ExperienciaLaboral : Pagina, IDeclaracionInicial
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ltrSubTitulo.Text = "Experiencia Laboral </br> <h6> Porporcionar información correspondiente a los últimos cinco empleos de experioencia laboral. Se llenará la información relativa a todos los encargos, empleos o comisiones públicas o privadas que haya tenido. </h6>";
        }

        public void Anterior()
        {
            HttpContext.Current.Items.Add("subSeccion", DatosGenerales.SubSecciones.DatosCurriculares);
