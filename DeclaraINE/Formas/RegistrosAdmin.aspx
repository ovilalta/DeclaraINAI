<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrosAdmin.aspx.cs" Inherits="DeclaraINAI.Formas.RegistrosAdmin" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Generación de reporte</a>
                        </li>
                    </ul>
                </div>
