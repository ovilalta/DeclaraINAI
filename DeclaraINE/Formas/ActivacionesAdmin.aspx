<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivacionesAdmin.aspx.cs" Inherits="DeclaraINAI.Formas.ActivacionesAdmin" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Activación de cuenta</a>
                        </li>
                    </ul>
                </div>
