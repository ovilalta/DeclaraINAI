<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteDeclaracionesInformeTrim.aspx.cs" Inherits="DeclaraINAI.Formas.Administrador.ReporteDeclaracionesInformeTrim" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Reporte Declaraciones Informe Trimestral</a>
                        </li>
                    </ul>
                </div>
