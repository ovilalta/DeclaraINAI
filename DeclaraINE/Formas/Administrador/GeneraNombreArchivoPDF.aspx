<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneraNombreArchivoPDF.aspx.cs" Inherits="DeclaraINAI.Formas.Administrador.GeneraNombreArchivoPDF" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Genera Nombre Archivos PDF</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col">
                    ...
                    <div class="subtitulo">
                        ...
                        <br />
                            ...
                            <asp:Button ID="brnActualizar" runat="server" Text="Genera Nombre Archivos PDF" OnClientClick="ValidatebtnEntrar();" OnClick="btnDescargar_Actualizar" CssClass="download" class="mb-3"/>
                            <br />
                            <br />  
                            <%-- Barra de progreso --%>
