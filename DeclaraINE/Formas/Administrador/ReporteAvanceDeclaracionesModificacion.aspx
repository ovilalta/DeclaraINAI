<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteAvanceDeclaracionesModificacion.aspx.cs" Inherits="DeclaraINAI.Formas.Administrador.ReporteAvanceDeclaracionesModificacion" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Reporte Avance Declaraciones Modificacion</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="subtitulo">
                        ...
                        <label style="float: left;">Ejercicio :</label>
                        <br />
                        
                            <asp:TextBox ID="txtAnio" runat="server" AutoCompleteType="Disabled" MaxLength="4"  ToolTip="Indique el ejercicio que desea revisar"></asp:TextBox>
