...
{
    public partial class ReporteDeclaracionesInformeTrim : Pagina
    {
        ...
        protected void btnDescargar_Actualizar(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string sql = "SP_ReporteDeclaracionesInformeTrimestral";
                ...
                using (SqlConnection conn = new SqlConnection(connString))
                {
                    try
                    {
                        using (SqlDataAdapter da = new SqlDataAdapter())
                        {
                            ...
                            book.SaveToHttpResponse("ReporteDeclaracionesInformeTrimestral.xls", Response);
                        }
                    }
                    catch (Exception ex)
                    {
