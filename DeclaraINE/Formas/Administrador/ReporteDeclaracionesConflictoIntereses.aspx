<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteDeclaracionesConflictoIntereses.aspx.cs" Inherits="DeclaraINAI.Formas.Administrador.ReporteDeclaracionesConflictoIntereses" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Reporte Declaraciones Conflicto Intereses</a>
                        </li>
                    </ul>
                </div>
