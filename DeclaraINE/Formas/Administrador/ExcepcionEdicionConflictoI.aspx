<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExcepcionEdicionConflictoI.aspx.cs" Inherits="DeclaraINAI.Formas.Administrador.ExcepcionEdicionConflictoI" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Agrega excepción para edición de Conflicto de Intereses</a>
                        </li>
                    </ul>
                </div>
