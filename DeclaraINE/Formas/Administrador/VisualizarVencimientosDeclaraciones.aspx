<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisualizarVencimientosDeclaraciones.aspx.cs" Inherits="DeclaraINAI.Formas.Administrador.VisualizarVencimientosDeclaraciones" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Visualizar vencimientos declaraciones</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col">
                    ...
                    <div class="subtitulo">
                        ...
                        <asp:GridView ID="gvExcelData" runat="server" 
                            ...
                            GridLines="None"
                            DataKeyNames="Id"
                            OnRowDataBound="gvExcelData_RowDataBound"
                           ...
                           <%-- <HeaderStyle HorizontalAlign="Center" />--%>
                            <Columns>
                                ...
                                <asp:BoundField DataField="FechaAplicacion" HeaderText="Fecha Aplicacion" DataFormatString="{0:dd/MM/yyyy}" HtmlEncode="False">
                                    <HeaderStyle CssClass="header-center" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="FechaVencimiento" HeaderText="Fecha Vencimiento" DataFormatString="{0:dd/MM/yyyy}" HtmlEncode="False">
                                    <HeaderStyle CssClass="header-center" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Cumplimiento">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkActivo" runat="server"
                                            Checked='<%# Convert.ToBoolean(Eval("EstatusCumplimiento")) %>'
                                            AutoPostBack="True" 
                                ...
                                <asp:BoundField DataField="CorreoPersonal" HeaderText="Correo Personal">
                                    <HeaderStyle CssClass="header-center" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>

                                <asp:BoundField DataField="CelularPersonal" HeaderText="Celular Personal">
                                    <HeaderStyle CssClass="header-center" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
