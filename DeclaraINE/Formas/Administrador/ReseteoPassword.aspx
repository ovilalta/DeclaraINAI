<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReseteoPassword.aspx.cs" Inherits="DeclaraINAI.Formas.Administrador.ReseteoPassword" %>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="subtitulo">
                        ...
                        <label style="float: left;">Indicar el RFC para resetear su contraseña:</label>
                        <br />
                        <asp:TextBox ID="txtRfc" runat="server"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Button ID="brnActualizar" runat="server" Text="Resetear Contraseña" OnClientClick="ValidatebtnEntrar();" OnClick="btnReseteoPass" CssClass="saveAs" class="mb-3" />
                    </div>
