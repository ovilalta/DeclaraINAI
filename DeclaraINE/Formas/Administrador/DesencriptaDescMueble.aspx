<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DesencriptaDescMueble.aspx.cs" Inherits="DeclaraINAI.Formas.Administrador.DesencriptaDescMueble" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Desencripta Descripción Bien Mueble</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col">
                    ...
                    <div class="subtitulo">
                        ...
                        <br />--%>
                            ...
                            <asp:Button ID="brnActualizar" runat="server" Text="Desencriptar" OnClientClick="ValidatebtnEntrar();" OnClick="BtnDesencriptar" CssClass="download" class="mb-3"/>
                            <br />
                            <br />  
