<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteAcusesFiscales.aspx.cs" Inherits="DeclaraINAI.Formas.Administrador.ReporteAcusesFiscales" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Reporte de Acuses Fiscales Totales por Año</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="subtitulo">
                        ...
                        <br />
                        <%--<asp:TextBox ID="anio" runat="server" AutoCompleteType="Disabled" MaxLength="4"></asp:TextBox>--%>
                        <asp:DropDownList runat="server" ID="ddlLista" />
                        <br />
                        <br />


                        <asp:Button ID="brnActualizar" runat="server" Text="Obtener Totales" OnClientClick="ValidatebtnEntrar();" OnClick="btnDescargar_Actualizar" CssClass="download" class="mb-3" />
                        <br />
                        <br />

                        <asp:Label ID="TotalAcusesFiscales" runat="server" Text=""></asp:Label>
                        <%-- Barra de progreso --%>
                    </div>
                </div>
            </div>
