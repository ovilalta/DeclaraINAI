<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CargaDeclaraciones.aspx.cs" Inherits="DeclaraINAI.Formas.Administrador.CargaDeclaraciones" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Carga Declaraciones Patrimoniales</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="subtitulo">
                        ...
                        <div class="row">   
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <asp:Button runat="server" ID="uploadedFile" Text="Carga Declaraciones Patrimoniales" OnClick="uploadFile_Click" CssClass="upload" class="mb-3"/>  
