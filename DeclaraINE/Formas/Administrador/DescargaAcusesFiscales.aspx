<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DescargaAcusesFiscales.aspx.cs" Inherits="DeclaraINAI.Formas.Administrador.DescargaAcusesFiscales" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Descarga Acuses Fiscales</a>
                        </li>
                    </ul>
                </div>
