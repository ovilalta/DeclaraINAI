<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteBitacora.aspx.cs" Inherits="DeclaraINAI.Formas.Administrador.ReporteBitacora" %>
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Reporte Bitácora Administrador</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="subtitulo">
                        ...
                        <br />
                        <br />
                        <asp:Button ID="brnActualizar" runat="server" Text="Generar Bitácora" OnClick="btnDescargar_Actualizar" CssClass="xls"/>
                        <div class="bar">
                        </div>
                    </div>
                </div>
