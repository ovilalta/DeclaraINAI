<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrlDependiente.ascx.cs" Inherits="DeclaraINAI.Formas.DeclaracionConclusion.ctrlDependiente" %>
...
<span style="color: red;  ">
    <asp:Label runat="server" ID="lbSubTitulo" Text=" " />
</span>



<asp:Panel runat="server" ID="tbAltaParejaDependiente" Visible="false">
    ...
    <table class="f">
        <tbody>
            ...
            <asp:Panel runat="server" ID="pnlDependiente">
                <tr>
                    <th>
                        <l><asp:label runat="server"  ID="lblDomicilioTitulo" /></l>
                    </th>
                </tr>
