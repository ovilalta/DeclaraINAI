    ...
    public partial class ModificaVehiculos : Pagina, IDeclaracionInicial
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (oDeclaracion.ALTA.ALTA_MUEBLEs.Count == 0 && oDeclaracion.MODIFICACION.MODIFICACION_MUEBLEs.Count == 0 && !oDeclaracion.DECLARACION_APARTADOs.Where(p => p.NID_APARTADO == 19).First().L_ESTADO.Value)
                    QstBox.Ask("¿Cuenta con vehículos que desee declarar?");
            }
        ...
        private void PagVehiculo()
        {
            ...
            for (int x = 0; x < oDeclaracion.MODIFICACION.MODIFICACION_VEHICULOs.Count; x++)
            {
                ...
                ((ItemVeh)item).ImageUrl = String.Concat("../../Images/CAT_TIPO_VEHICULO/", 1, ".png");
                ((ItemVeh)item).Editar += OnEditar;
                if (o.L_MODIFICADO) ((Button)((ItemVeh)item).FindControl("btnEditar")).CssClass = "ok";
        ...
        {
            if (oDeclaracion.MODIFICACION.MODIFICACION_VEHICULOs.Where(p => p.L_MODIFICADO = false).Any()) { }
            else
            {
        ...
        private void EditarVehiculo()
        {
            ...
            try
            {
                ...
                ((Button)((ItemVeh)grd.FindControl(String.Concat("Vehiculo_P", Indice))).FindControl("btnEditar")).CssClass = "ok";
        ...
        protected void btnAgregarVehiculo_Click(object sender, EventArgs e)
        {
            ...
            lEditarN = false;
            InfoAdeudo = null;
            mppVehículosN.HeaderText = "Agregar vehículo";
        ...
        private void PagVehiculoN()
        {
            ...
            if (!IsPostBack)
            {
                ...
                chbDependietesVehiculoN.Items.Insert(chbDependietesVehiculoN.Items.Count, new ListItem("Copropietario", "-1"));
            }
            ////Dependientes
        ...
        protected void OnEditarN(object sender, ItemEventArgs e)
        {
            ...
            blld_ALTA_VEHICULO v;
            lEditarN = true;
            mppVehículosN.HeaderText = "Editar vehículo";
            mppVehículosN.Show(true);
