<%@ Page Title="" Language="C#" MasterPageFile="~/Formas/DeclaracionConclusion/_Conclusion.master" AutoEventWireup="true" CodeBehind="DatosGenerales.aspx.cs" Inherits="DeclaraINAI.Formas.DeclaracionConclusion.DatosGenerales" EnableEventValidation="false" Culture="es-MX" UICulture="es-MX" %>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            </asp:TextBox><asp:TextBox ID="txtvIdFecha" runat="server" Enabled="false" CssClass="n2">
                            </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
            ...
            <table class="f">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox Enabled="false" Text="Insurgentes Sur" ID="TextBox1" runat="server" requerido="btnSiguiente" CssClass="n3" MaxLength="150"></asp:TextBox>
                            <asp:TextBox Enabled="false" Text="3211" ID="TextBox2" runat="server" requerido="btnSiguiente" CssClass="n3" MaxLength="15"></asp:TextBox>
                            <asp:TextBox Enabled="false" ID="TextBox3" runat="server" CssClass="n3" MaxLength="15"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox4" text="Insurgentes Cuicuilco" runat="server" requerido="btnSiguiente" MaxLength="255" Enabled="false"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox5" text="04530" runat="server" MaxLength="5" OnTextChanged="C_CODIGO_POSTAL_TextChanged" AutoPostBack="true" requerido="btnSiguiente" Enabled="false"></asp:TextBox>
