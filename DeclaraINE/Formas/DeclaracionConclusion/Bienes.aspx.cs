...
namespace DeclaraINE.Formas.DeclaracionConclusion
{
    public partial class Bienes : Pagina, IDeclaracionInicial
    {
                ...
                switch (SubSeccionActiva)
                {
                    ...
                    case SubSecciones.OtrosBienes:
                       ...
                       // ltrSubTitulo.Text = "Bienes - Otros Bienes Muebles";
                        ltrSubTitulo.Text = "12. Bienes muebles </br><h6> Todos los datos de bienes declarados a nombre de la pareja, dependientes económicos y/o terceros o que sean en copropiedad con el declarante no serán públicos </br> Bienes del declarante, pareja y/o dependientes económicos"; 
        ...
        protected void OnEditar(object sender, ItemEventArgs e)
        {
            ...
            switch (SubSeccionActiva)
            {
                case SubSecciones.BienesInmuebles:
                    ...
                    blld_ALTA_INMUEBLE i;
                    blld_ALTA_INMUEBLE_COPROPIETARIO o;
                    lEditar = true;
        ...
        {
            mppMuebles.HeaderText = "Agregar bien mueble";
            mppMuebles.Show(true);
        ...
        {
            //MsgBox.ShowInfo(chbDependietesInm.Text);
