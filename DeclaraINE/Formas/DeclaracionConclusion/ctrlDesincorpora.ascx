<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrlDesincorpora.ascx.cs" Inherits="DeclaraINE.Formas.DeclaracionConclusion.ctrlDesincorpora" %>
...
<table class="f">
    <tbody>
        ...
        <tr>
            <th>
                <l>Fecha de la Venta, ]Siniestro o Donación</l>
            </th>
            <td>
