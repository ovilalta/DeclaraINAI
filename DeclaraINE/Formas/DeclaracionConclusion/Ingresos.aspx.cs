...
namespace DeclaraINAI.Formas.DeclaracionConclusion
{
    public partial class Ingresos : Pagina, IDeclaracionInicial
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ltrSubTitulo.Text = "8. Ingresos netos del año en curso a la fecha de conclusión del empleo, cargo o comisión del declarante, pareja y/o dependientes económicos. <br/> <h6> Capturar cantidades libres de impuestos, sin comas, sin puntos, sin centavos y sin ceros a la izquierda </h6>";
