<%@ Page Title="" Language="C#" MasterPageFile="~/Formas/DeclaracionConclusion/_Conclusion.master" AutoEventWireup="true" CodeBehind="Bienes.aspx.cs" Inherits="DeclaraINAI.Formas.DeclaracionConclusion.Bienes" Culture="es-MX" UICulture="es-MX" %>
            ...
            <table class="f">
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="cmbPaisInmueble" runat="server" CssClass="n3" OnSelectedIndexChanged="cmbPaisInmueble_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                            <asp:DropDownList ID="cmbEntidadFederativaInmueble" runat="server" CssClass="n3" OnSelectedIndexChanged="cmbEntidadFederativaInmueble_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                            <asp:DropDownList ID="cmbMunicipioInmueble" runat="server" CssClass="n3" requerido="btnGuardarInmueble"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtTipoMoneda" runat="server"  Visible="false" MaxLength="128"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="flista">
                            ...
                            <asp:CheckBoxList CssClass="table table-striped table-hover" ID="chbDependietes" runat="server" Visible="FALSE" RepeatDirection="Vertical">
               ...
               <%-- <tr>
                ...
                <tr runat="server" visible="true">
                 ...
                 <tr style="display:none">
                     <th>
                            <l>Fecha de baja del inmueble</l>
                        </th>
                     <td>
            ...
            <table class="f">
                <tbody>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtTipoMonedaMueble" runat="server" Visible="false" requerido="btnGuardarMueble" MaxLength="128"></asp:TextBox>
                    </td>
                </tr>
               ...
               <%-- <tr>
                ...
                <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="cmbTransmisorMueble" runat="server"  >
                                <asp:ListItem Text="" Value=""></asp:ListItem>
                                <asp:ListItem Text="Persona Física" Value="F"></asp:ListItem>
                                <asp:ListItem Text="Persona Moral"  Value="M"></asp:ListItem>
                            </asp:DropDownList>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtNombreTransmisorMueble" runat="server" MaxLength="256"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        <asp:TextBox ID="txtRFCTransmisorMueble" runat="server"  MaxLength="13"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="cmbRelacionTransmisorMueble" runat="server" ></asp:DropDownList>
            ...
            <table class="f">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtTipoMonedaVehiculo" runat="server" Visible="false" requerido="btnGuardarVehiculo" MaxLength="128"></asp:TextBox>
                    </td>
                </tr>
               <tr>
                    <th>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="cmbFormaAdquisicionVehiculo" runat="server" requerido="btnGuardarVehiculo"></asp:DropDownList>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="cmbFormaPagoVehiculo" runat="server" requerido="btnGuardarVehiculo"></asp:DropDownList>
                 ...
                 <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtNumeroSerie" runat="server" requerido="btnGuardarVehiculo" MaxLength="256"></asp:TextBox>
                    </td>
                </tr>
