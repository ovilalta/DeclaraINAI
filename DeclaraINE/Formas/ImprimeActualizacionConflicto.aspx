<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImprimeActualizacionConflicto.aspx.cs" Inherits="DeclaraINAI.Formas.ImprimeActualizacionConflicto" %>
    ...
    <form id="form1" runat="server" autocomplete="off">
        ...
        <script>
            ...
            function MensajeAcuseEnvio(state) {
                debugger
                if (state) {
                    $('#lbMensaje').html("Descargando..., favor de esperar, al finalizar verifique su descarga");
                } else
                    $('#lbMensaje').html();
                return true;
            }
                ...
                <div>
                    ...
                    <ul class="nav nav-tabs menu2020">
                        <li runat="server" enableviewstate="false" id="liDatosGenerales" class="active">
                            <a href="#menu1" data-toggle="tab">Descargar Declaración de Conflicto de Intereses</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div id="cuerpo">
                        ...
                        <div runat="server" id="grd">
                            <div>
                                ...
                                <div class="a">
                                    <label>
                                        Descargar Declaración de Conflicto de Intereses Actualizada
                                    </label>
                                </div>
                            </div>
