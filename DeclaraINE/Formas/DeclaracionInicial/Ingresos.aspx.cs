...
namespace DeclaraINE.Formas.DeclaracionInicial
{
    public partial class Ingresos : Pagina, IDeclaracionInicial
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ltrSubTitulo.Text = "8. Ingresos Netos del declarante, pareja y/o dependientes económicos (situación actual) <br/> <h6> Capturar cantidades libres de impuestos, sin comas, sin puntos, sin centavos y sin ceros a la izquierda </h6>";
