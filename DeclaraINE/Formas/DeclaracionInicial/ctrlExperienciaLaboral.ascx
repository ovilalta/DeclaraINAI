<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrlExperienciaLaboral.ascx.cs" Inherits="DeclaraINAI.Formas.DeclaracionInicial.ctrlExperienciaLaboral" %>
                    ...
                    <ContentTemplate>
                        <div class="yesno">
                            <div>
                                ...
                                <asp:RadioButton ID="rbtnOtro" GroupName="yn" runat="server" CssClass="yes" Text="Otro (Especifíque)" OnCheckedChanged="rbtPrOtro_CheckedChanged" AutoPostBack="true" />
                            </div>
