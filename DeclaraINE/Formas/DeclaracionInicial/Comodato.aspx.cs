...
namespace DeclaraINE.Formas.DeclaracionInicial
{
    public partial class Comodato : Pagina, IDeclaracionInicial
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
               ...
               // cmbNID_TIPO_RELACION.Items.Insert(cmbNID_TIPO_RELACION.Items.Count, new ListItem("Copropietario", "-1"));
                cmbNID_TIPO_RELACION.SelectedValue = "18";
                //*********************
                ...
                cmdNID_TIPO_VEHICULO.Items.RemoveAt(4);
            ...
            ltrSubTitulo.Text = "15. Préstamo o Comodato por terceros(situación actual)";
            string Contenedor;
            string Identifica;
            string Principal;
            string Secundario;
    ...
    private void Pinta()
        ...
        private void LimpiaDatos()
        {
            ...
            txtvSegundo_Apellido.Text = string.Empty;
            txtvPrimer_Apelido.Text = string.Empty;
            divObservaciones.Visible = false;


            txtTipo_relacion.Text = String.Empty;
        ...
        protected void OnEditar(object sender, ItemEventArgs e)
        {
            ...
            if(Selecciona=="1")
            {
                mppDatos.HeaderText = "Editar préstamo o comodato por terceros";
                mppDatos.Show(true);
                this.idVeviculos.Visible = false;
                ...
                this.txtvNombre.Text = i.E_TITULAR.ToString().Split('|')[0];
                this.txtTipo_relacion.Text= i.E_TITULAR.ToString().Split('|')[1];

                try { this.txtvPrimer_Apelido.Text = i.E_TITULAR.ToString().Split('|')[2]; } catch { }
                try { this.txtvSegundo_Apellido.Text = i.E_TITULAR.ToString().Split('|')[3]; } catch { }
        ...
        private void EditaDatos()
        {
            ...
            try
            {
                ...
                oDeclaracion.ALTA.ALTA_COMODATOs[Indice].E_TITULAR = txtvNombre.Text+"|"+txtTipo_relacion.Text + "|" + txtvPrimer_Apelido.Text + "|" + txtvSegundo_Apellido.Text; 
        ...
        private void GuardaDatos()
        {
            ...
            try
            {
                oDeclaracion.ALTA.Add_ALTA_COMODATOs(
                                                      ...
                                                      , txtvNombre.Text + "|" + txtTipo_relacion.Text + "|" + txtvPrimer_Apelido.Text + "|" + txtvSegundo_Apellido.Text
                                                      , txtvRFC.Text
