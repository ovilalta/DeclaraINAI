...
<%@ Register Src="~/Formas/DeclaracionInicial/Adeudo.ascx" TagPrefix="ascx" TagName="Adeudo" %>
        ...
        <ContentTemplate>
            <table class="f">
                <tr>
                    ...
                    <tr>
                        <th>
                            <l><asp:Label ID="idLocal_colon" runat="server" Text="Colonia/Localidad"></asp:Label></l>
                        </th>
                        <td>
