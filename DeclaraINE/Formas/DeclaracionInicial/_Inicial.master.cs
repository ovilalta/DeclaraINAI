...
{
    public partial class _Inicial : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(Page.Title))
                Page.Title = "Declaración Inicial";
            else
                Page.Title = String.Concat("Declaración Inicial: ", Page.Title);
            if (!IsPostBack)
            {
                this.lblEjercicio.Text = string.Concat("Ejercicio :", oDeclaracion.C_EJERCICIO);
                this.lblIdentificacion.Text = string.Concat("Declaración Inicial ", oDeclaracion.VID_NOMBRE, oDeclaracion.VID_FECHA, oDeclaracion.VID_HOMOCLAVE, " - ", oUsuario.V_NOMBRE_COMPLETO);
            }
            ...
            if (oDeclaracion.DECLARACION_APARTADOs.Where(p => p.NID_APARTADO == 1).First().L_ESTADO.Value)
            {
                ...
                if (obligado != null)
                {
                    ...
                    //Muestra boton de vista preliminar
        ...
        public static void ImprimirAcuseInicial(blld_DECLARACION oDeclaracion, blld_USUARIO oUsuario)
        {
            ...
            file.fileSoapClient o = new file.fileSoapClient();
            FileStream fs1;
            SerializedFile sf = o.ObtenReportePorId(Pagina.FileServiceCredentials, 2020, "ACUSE_INICIAL", new List<object> { oUsuario.VID_NOMBRE
                                                                               ,oUsuario.VID_FECHA
