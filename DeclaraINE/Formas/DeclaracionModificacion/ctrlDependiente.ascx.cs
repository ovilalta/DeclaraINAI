...
namespace DeclaraINE.Formas.DeclaracionModificacion
{
    public partial class ctrlDependiente : System.Web.UI.UserControl
    {
        ...
        public String NID_TIPO_DEPENDIENTE
        {
            ...
            set
            {
                try { cmbNID_TIPO_DEPENDIENTE_DEP.SelectedValue = value; } catch { }
        ...
        public void llena(blld_DECLARACION_DEPENDIENTES Dependiente)
        {
            this.Selected_id = Dependiente.NID_DEPENDIENTE;
        ...
        protected void rbtnPu_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                blld_DECLARACION_DEPENDIENTES_PUBLICO oDepPublico = new blld_DECLARACION_DEPENDIENTES_PUBLICO(oDependiente.VID_NOMBRE, oDependiente.VID_FECHA, oDependiente.VID_HOMOCLAVE, oDependiente.NID_DECLARACION, oDependiente.NID_DEPENDIENTE);
        ...
        protected void rbtPr_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                blld_DECLARACION_DEPENDIENTES_PRIVADO oDepPrivado = new blld_DECLARACION_DEPENDIENTES_PRIVADO(oDependiente.VID_NOMBRE, oDependiente.VID_FECHA, oDependiente.VID_HOMOCLAVE, oDependiente.NID_DECLARACION, oDependiente.NID_DEPENDIENTE);
        ...
        internal void SelectPareja()
        {
            ...
            try
            {
                ...
                lblDomicilio.Text = "¿Habita en el domicilio del declarante?";
                lblDomicilioTitulo.Text = "Domicilio del la pareja";
                lbSubTitulo.Text = string.Empty;
        ...
        internal void SelectDependiente()
        {
            ...
            try
            {
                ...
                lblDomicilio.Text = "¿Habita en el domicilio del declarante?";
                lbSubTitulo.Text = "Todos los datos relativos a menores de edad no serán públicos";
                lblDomicilioTitulo.Text = "Domicilio del dependiente económico";
