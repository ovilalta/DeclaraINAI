...
namespace DeclaraINE.Formas.DeclaracionModificacion
{
    public partial class Bienes : Pagina, IDeclaracionInicial
    {
        ...
        {
            blld_DECLARACION oDeclaracion = _oDeclaracion;
            ((_Modificacion)Master).links_Bienes(ref oDeclaracion);
        ...
        private void conInmuebles()
        {
            ...
            if (!IsPostBack)
            {
                ...
                //String Paso= oDeclaracion.DECLARACION_DEPENDIENTESs.First().NID_DEPENDIENTE.ToString();
                //chbDependietesInm.SelectedValue = oDeclaracion.DECLARACION_DEPENDIENTESs.First().NID_DEPENDIENTE.ToString();
            ...
            for (int x = 0; x < oDeclaracion.ALTA.ALTA_INMUEBLEs.Count; x++)
            {
                ...
                ((ItemBaja)item).Id = x;
                ((ItemBaja)item).ID = String.Concat("Inmueble_", x);

                ((ItemBaja)item).TextoPrincipal = i.V_TIPO;
                ((ItemBaja)item).TextoSecundario = i.V_CALLE + " " + i.V_NUMERO_EXTERNO;
                ((ItemBaja)item).ImageUrl = String.Concat("../../Images/CAT_TIPO_INMUEBLE/", i.NID_TIPO, ".png");
                ((ItemBaja)item).Editar += OnEditar;
                ((ItemBaja)item).Eliminar += OnEliminar;
                ((ItemBaja)item).Bajar += OnBaja;
                //if (i.F_ADQUISICION < String.Concat("01/01/",Convert.ToString(System.DateTime.Today.Year-1)).Date())
                //{ 
        ...
        private void conMuebles()
        {
            ...
            if (!IsPostBack)
            {
                ...
                var cnx = new MODELDeclara_V2.cnxDeclara();
                var lista = cnx.CAT_MONEDA;
                ddlTipoMonedaMue.DataTextField = "V_CODIGO_MONEDA";
                ddlTipoMonedaMue.DataValueField = "NID_MONEDA";
                ddlTipoMonedaMue.DataSource = lista.ToList();
                ddlTipoMonedaMue.DataBind();
                ddlTipoMonedaMue.SelectedValue = "101";
            ...
            for (int x = 0; x < oDeclaracion.ALTA.ALTA_MUEBLEs.Count(); x++)
            {
                ...
                UserControl item = (UserControl)Page.LoadControl("ItemBaja.ascx");
                ((ItemBaja)item).Id = x;
                ((ItemBaja)item).ID = String.Concat("Mueble_", x);
                ((ItemBaja)item).TextoPrincipal = b.V_TIPO;
                ((ItemBaja)item).TextoSecundario = b.E_ESPECIFICACION;
                ((ItemBaja)item).ImageUrl = String.Concat("../../Images/CAT_TIPO_MUEBLE/", b.NID_TIPO, ".png");
                ((ItemBaja)item).Editar += OnEditar;
                ((ItemBaja)item).Eliminar += OnEliminar;
                ((ItemBaja)item).Bajar += OnBaja;
                //if (b.F_ADQUISICION < String.Concat("01/01/", Convert.ToString(System.DateTime.Today.Year - 1)).Date())
                //{
                //    ((Button)((ItemBaja)item).FindControl("btnEliminar")).Visible = false;
                //    ((Button)((ItemBaja)item).FindControl("btnBaja")).Visible = false;
                //}
        ...
        private void conVehiculos()
        {
            ...
            if (!IsPostBack)
            {
                ...
                var cnx = new MODELDeclara_V2.cnxDeclara();
                var lista = cnx.CAT_MONEDA;
                ddlTipoMonedaVeh.DataTextField = "V_CODIGO_MONEDA";
                ddlTipoMonedaVeh.DataValueField = "NID_MONEDA";
                ddlTipoMonedaVeh.DataSource = lista.ToList();
                ddlTipoMonedaVeh.DataBind();
                ddlTipoMonedaVeh.SelectedValue = "101";
            ...
            for (int x = 0; x < oDeclaracion.ALTA.ALTA_VEHICULOs.Count(); x++)
            {
                ...
                UserControl item = (UserControl)Page.LoadControl("ItemBaja.ascx");
                ((ItemBaja)item).Id = x;
                ((ItemBaja)item).ID = String.Concat("Vehiculo_", x);
                ((ItemBaja)item).TextoPrincipal = v.V_MARCA.ToString();
                ((ItemBaja)item).TextoSecundario = v.V_DESCRIPCION;
                ((ItemBaja)item).ImageUrl = String.Concat("../../Images/CAT_TIPO_VEHICULO/", v.NID_TIPO_VEHICULO, ".png");
                ((ItemBaja)item).Editar += OnEditar;
                ((ItemBaja)item).Eliminar += OnEliminar;
                ((ItemBaja)item).Bajar += OnBaja;
                //if (v.F_ADQUISICION < String.Concat("01/01/", Convert.ToString(System.DateTime.Today.Year - 1)).Date())
                //{
                //    ((Button)((ItemBaja)item).FindControl("btnEliminar")).Visible = false;
                //    ((Button)((ItemBaja)item).FindControl("btnBaja")).Visible = false;
                //}
            ...
            if (!IsPostBack)
            {
                ...
                switch (SubSeccionActiva)
                {
                    case SubSecciones.BienesInmuebles:
                        ...
                        //ltrSubTitulo.Text = "9. Bienes Inmuebles (entre el 1 de enero y el 31 de diciembre del año inmediato anterior) </br><h6> Todos los datos de bienes declarados a nombre de la pareja, dependientes económicos y/o terceros o que sean en copropiedad con el declarante no serán públicos  </br> Bienes del declarante, pareja y/o dependientes económicos";
                        ltrSubTitulo.Text = "9. Bienes Inmuebles (entre el 1 de enero y el 31 de diciembre del año inmediato anterior) </br><h6> Todos los datos de bienes declarados a nombre de la pareja, dependientes económicos y/o terceros o que sean en copropiedad con el declarante no serán públicos  </br> Debes registrar los inmuebles de tu propiedad, de tu pareja y/o dependientes económicos.";
                        ...
                        if (oDeclaracion.ALTA.ALTA_INMUEBLEs.Count == 0 && !oDeclaracion.DECLARACION_APARTADOs.Where(p => p.NID_APARTADO == 8).First().L_ESTADO.Value)
                            QstBoxInm.Ask("Debes registrar los inmuebles de tu propiedad, de tu pareja y/o dependientes económicos. </br></br>¿Deseas continuar con el registro en este momento?");
                        break;
                    ...
                    case SubSecciones.OtrosBienes:
                        ...
                        //ltrSubTitulo.Text = "11. Bienes muebles (entre el 1 de enero y el 31 de diciembre del año inmediato anterior)</br><h6> Todos los datos de bienes declarados a nombre de la pareja, dependientes económicos y/o terceros o que sean en copropiedad con el declarante no serán públicos </br> Bienes del declarante, pareja y/o dependientes económicos";
                        ltrSubTitulo.Text = "11. Bienes muebles (entre el 1 de enero y el 31 de diciembre del año inmediato anterior)</br><h6> Todos los datos de bienes declarados a nombre de la pareja, dependientes económicos y/o terceros o que sean en copropiedad con el declarante no serán públicos </br> Debes registrar los muebles de tu propiedad, de tu pareja y/o dependientes económicos.";
                        ...
                        if (oDeclaracion.ALTA.ALTA_MUEBLEs.Count == 0 && !oDeclaracion.DECLARACION_APARTADOs.Where(p => p.NID_APARTADO == 9).First().L_ESTADO.Value)
                            QstBoxMue.Ask("Debes registrar los muebles de tu propiedad, de tu pareja y/o dependientes económicos.</br></br>¿Deseas continuar con el registro en este momento?");
                        break;
                    case SubSecciones.Vehiculos:
                        ((Button)Master.FindControl("btnAnterior")).Visible = true;
                        ViewState["SubSeccionActiva"] = SubSecciones.Vehiculos;
                        //ltrSubTitulo.Text = "Bienes - Vehículos";
                        //ltrSubTitulo.Text = "10. Vehículos (entre el 1 de enero y el 31 de diciembre del año inmediato anterior)</br><h6> Todos los datos de vehículos declarados a nombre de la pareja, dependientes económicos y/o terceros o que sean en copropiedad con el declarante no serán públicos </br> Vehículos del declarante, pareja y/o dependientes económicos";
                        ltrSubTitulo.Text = "10. Vehículos (entre el 1 de enero y el 31 de diciembre del año inmediato anterior)</br><h6> Todos los datos de vehículos declarados a nombre de la pareja, dependientes económicos y/o terceros o que sean en copropiedad con el declarante no serán públicos </br> Debes registrar los vehículos de tu propiedad, de tu pareja y/o dependientes económicos.";
                        pnlBienesInmuebles.Visible = false;
                        pnlOtrosBienes.Visible = false;
                        ...
                        if (oDeclaracion.ALTA.ALTA_MUEBLEs.Count == 0 && !oDeclaracion.DECLARACION_APARTADOs.Where(p => p.NID_APARTADO == 10).First().L_ESTADO.Value)
                            QstBoxVehic.Ask("Debes registrar los vehículos de tu propiedad, de tu pareja y/o dependientes económicos. </br></br>¿Deseas continuar con el registro en este momento?");
                        break;
                }
            ...
            switch (SubSeccionActiva)
            {
                case SubSecciones.BienesInmuebles:
                   ...
                   // chbDependietes.ClearSelection();
                    ...
                    try { txtRegistroPublicoPropiedad.Text = i.E_REGISTRO_PUBLICO_PROPIEDAD.ToString(); } catch { }
                   // txtRegistroPublicoPropiedad.Text = i.E_REGISTRO_PUBLICO_PROPIEDAD.ToString();
                    ...
                    try { txtRFCTransmisor.Text = i.E_RFC_TRANSMISOR.ToString(); } catch { }
                    //txtRFCTransmisor.Text = i.E_RFC_TRANSMISOR.ToString();
                   
                    cmbRelacionTransmisor.SelectedValue = i.NID_RELACION_TRANSMISOR.ToString();

                    try { txtObservacionesBienesInmuebles.Text = i.E_OBSERVACIONES.ToString(); } catch { }
                    ...
                    //if (i.F_ADQUISICION > String.Concat("01/01/", Convert.ToString(System.DateTime.Today.Year - 1)).Date())
                    //{
                        this.RenglonAdeudo.Visible = true;
                    //}
                    //else
                    //{
                    //    this.RenglonAdeudo.Visible = false;
                    //}
                ...
                case SubSecciones.OtrosBienes:
                    ...
                    try { txtObservacionesBienesMuebles.Text = m.E_OBSERVACIONES.ToString(); } catch { }
                ...
                case SubSecciones.Vehiculos:
                    ...
                    try { txtNumeroSerie.Text = v.E_NUMERO_SERIE.ToString(); } catch { }
                   // txtNumeroSerie.Text = v.E_NUMERO_SERIE.ToString();
                    ...
                    //if (v.F_ADQUISICION > String.Concat("01/01/", Convert.ToString(System.DateTime.Today.Year - 1)).Date())
                    //{
                        this.RenglonAdeudoVeh.Visible = true;
                    //}
                    //else
                    //{
                    //    this.RenglonAdeudoVeh.Visible = false;
                    //}
                    //txtNombreTransmisor
                    ...
                    try { txtObservacionesVehiculos.Text = v.E_OBSERVACIONES.ToString(); } catch { }
        ...
        protected void btnAgregarInmuebles_Click(object sender, EventArgs e)
        {
           ...
           // cmbTipoUso.ClearSelection();
            ...
            ddlTipoMonedaInm.SelectedValue = "101"; //Por default MXN
        ...
        private void GuardarInmueble()
        {
            ...
            try
            {
                ...
                UserControl item = (UserControl)Page.LoadControl("ItemBaja.ascx");
                ((ItemBaja)item).Id = oDeclaracion.ALTA.ALTA_INMUEBLEs.Count - 1;
                ((ItemBaja)item).TextoPrincipal = o.V_TIPO;
                ((ItemBaja)item).TextoSecundario = o.V_CALLE + " " + o.V_NUMERO_EXTERNO; ;
                ((ItemBaja)item).ImageUrl = String.Concat("../../Images/CAT_TIPO_INMUEBLE/", o.NID_TIPO, ".png");
                ((ItemBaja)item).Editar += OnEditar;
                ((ItemBaja)item).Eliminar += OnEliminar;
                ((ItemBaja)item).Bajar += OnBaja;
                //if (o.F_ADQUISICION < String.Concat("01/01/", Convert.ToString(System.DateTime.Today.Year - 1)).Date())
                //{
                //    ((Button)((ItemBaja)item).FindControl("btnEliminar")).Visible = false;
        ...
        private void EditarInmueble()
        {
            ...
            chbDependietes.SelectedValue = chbDependietesInm.SelectedValue;
            //chbDependietes.Items.Add(Convert.ToInt32( chbDependietesInm.SelectedValue.ToString()));
            ...
            try
            {
               ...
               //oDeclaracion.ALTA.ALTA_INMUEBLEs[Indice].E_UBICACION = "";
        ...
        protected void cmbPaisInmueble_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                this.idLocal_colon.Text = "Localidad o Colonia";
        ...
        protected void btnAgregarMueble_Click(object sender, EventArgs e)
        {
            ...
            ddlTipoMonedaMue.SelectedValue = "101"; //Por default MXN
            ddlTipoMonedaMue_SelectedIndexChanged(sender, e);
        ...
        private void GuardarMueble()
        {
            ...
            try
            {
                ...
                ((ItemBaja)item).ID = String.Concat("Mueble_", x);
                ((ItemBaja)item).TextoPrincipal = o.V_TIPO;
                ((ItemBaja)item).TextoSecundario = o.E_ESPECIFICACION;
                ((ItemBaja)item).ImageUrl = String.Concat("../../Images/CAT_TIPO_MUEBLE/", o.NID_TIPO, ".png");
                ((ItemBaja)item).Editar += OnEditar;
                ((ItemBaja)item).Eliminar += OnEliminar;
        ...
        protected void btnAgregarVehiculo_Click(object sender, EventArgs e)
        {
           ...
           // dpTipoUso.ClearSelection();
            ...
            ddlTipoMonedaVeh.SelectedValue = "101"; //Por default MXN
            ddlTipoMonedaVeh_SelectedIndexChanged(sender, e);
        ...
        private void GuardarVehiculo()
        {
            ...
            try
            {
                ...
                UserControl item = (UserControl)Page.LoadControl("ItemBaja.ascx");
                ((ItemBaja)item).Id = x;
                ((ItemBaja)item).TextoPrincipal = v.V_MARCA;
                ((ItemBaja)item).TextoSecundario = v.V_DESCRIPCION;
                ((ItemBaja)item).ImageUrl = String.Concat("../../Images/CAT_TIPO_VEHICULO/", v.NID_TIPO_VEHICULO, ".png");
                ((ItemBaja)item).Editar += OnEditar;
                ((ItemBaja)item).Eliminar += OnEliminar;
        ...
        protected void btnEditarAdeudo1_Click(object sender, EventArgs e)
        {
            ...
            Adeudo.NOM_DEPENDIENTE = oDeclaracion.ALTA.ALTA_INMUEBLEs[Indice].ALTA_ADEUDOs[0].ALTA_ADEUDO_TITULARs.Select(p => p.NID_DEPENDIENTE).First(); 
        ...
        protected void btnEditarAdeudo2_Click(object sender, EventArgs e)
        {
            ...
            Adeudo.NOM_DEPENDIENTE = oDeclaracion.ALTA.ALTA_INMUEBLEs[Indice].ALTA_ADEUDOs[1].ALTA_ADEUDO_TITULARs.Select(p => p.NID_DEPENDIENTE).First();
        }
        ...
        protected void btnModificarAdeudoVehiculo_Click(object sender, EventArgs e)
        {
            ...
            Adeudo.E_RFC_TERCERO = oDeclaracion.ALTA.ALTA_VEHICULOs[Indice].ALTA_ADEUDOs[IndiceAdeudo].E_RFC_TERCERO;

            Adeudo.E_NOMBRE_TERCERO = oDeclaracion.ALTA.ALTA_VEHICULOs[Indice].ALTA_ADEUDOs[IndiceAdeudo].E_NOMBRE_TERCERO;
            Adeudo.NID_TERCERO = oDeclaracion.ALTA.ALTA_VEHICULOs[Indice].ALTA_ADEUDOs[IndiceAdeudo].NID_TERCERO;
            ...
            Adeudo.NOM_DEPENDIENTE = oDeclaracion.ALTA.ALTA_VEHICULOs[Indice].ALTA_ADEUDOs[IndiceAdeudo].ALTA_ADEUDO_TITULARs.Select(p => p.NID_DEPENDIENTE).First();
            ...
            try
            {
                ...
                if (lEditar)
                {
                    ...
                    if (lEditaAdeudo)
                    {
                        ...
                        oDeclaracion.ALTA.ALTA_VEHICULOs[Indice].ALTA_ADEUDOs[IndiceAdeudo].NID_TIPO_ADEUDO = Adeudo.NID_TIPO_ADEUDO;
