<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Adeudo.ascx.cs" Inherits="DeclaraINE.Formas.DeclaracionModificacion.Adeudo" %>
...
<table class="f">
    <tbody>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="cmbNID_TIPO_ADEUDO" runat="server" requerido="btnGuardarAdeudo" AutoPostBack="True">
                                    <asp:ListItem Text=" "></asp:ListItem>
                                    <asp:ListItem Text="Crédito Hipotecario"  Value= "3"></asp:ListItem>
                                    <asp:ListItem Text="Crédito Automotriz"  Value= "2"></asp:ListItem>
                                    <asp:ListItem Text="Crédito Personal"  Value= "8"></asp:ListItem>
                                    <asp:ListItem Text="Tarjeta de crédito bancaria"  Value= "6"></asp:ListItem>
                                    <asp:ListItem Text="Tarjeta de crédito departamental"  Value= "7"></asp:ListItem>
                                    <asp:ListItem Text="Préstamo Personal"  Value= "4"></asp:ListItem>
        ...
        <tr>
            <th>
                <l>Saldo insoluto al 31 de diciembre del año inmediato anterior</l>
            </th>
            <td>
          ...
          <tr  runat="server" id="ComboTercero">
            <th>
                <l>Tercero</l>
            </th>
            <td>
        ...
        <tr runat="server" id="NombreTercero">
            <th>
        ...
        <tr runat="server" id="RFCTercero">
            <th>
               <l>RFC del Tercero</l> 
            </th>
            <td>
                <asp:TextBox ID="txtRfc_Terceros" runat="server" Visible="true" CssClass="n2" MaxLength="13"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            <th>
                <l>Nombre Institución o Razón Social</l>
            </th>
            <td>
                <asp:DropDownList ID="cmbNID_INSTITUCION" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cmbNID_INSTITUCION_SelectedIndexChanged" requerido="btnGuardarAdeudo" CssClass="n2"> </asp:DropDownList>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtRfc" runat="server" Visible="true" requerido="btnGuardarAdeudo" CssClass="n2" MaxLength="13"></asp:TextBox>
            </td>
        </tr>
         <tr>
            <th>
                <l>¿Dónde se localiza el adeudo?</l>
            </th>
            <td>
        ...
        <tr style="display: none">
            <th>
                <l>Fecha de baja del adeudo</l>
            </th>
            <td>

                <asp:TextBox ID="txtF_BAJA" runat="server" Date="S" MaxLength="10"></asp:TextBox>
                <asp:CalendarExtender runat="server" ID="txtF_BAJA_C" TargetControlID="txtF_BAJA" Format="dd/MM/yyyy" />
            </td>
        </tr>

        <tr runat="server" id="ComentaObservación">
            <th>
