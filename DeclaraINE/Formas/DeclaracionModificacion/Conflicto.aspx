<%@ Page Title="" Language="C#" MasterPageFile="~/Formas/DeclaracionModificacion/_Modificacion.master" AutoEventWireup="true" CodeBehind="Conflicto.aspx.cs" Inherits="DeclaraINAI.Formas.DeclaracionModificacion.Conflicto" Culture="es-MX" UICulture="es-MX" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ChildContent2" runat="server">
    ...
    <div class="subtitulo">
        <asp:Literal ID="ltrSubTitulo" runat="server" Text="II. Declaración de Intereses <br/><h6> Todos los datos de la participación en empresas, sociedades o asociaciones de la pareja o dependientes económicos no serán públicos"></asp:Literal>
    </div>
    <div id="cuerpo">
        <label>
