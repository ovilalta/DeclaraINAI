...
{
    public partial class AdeudoModificaInicio : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                oInstitucion.OrderByCriterios.Add(new Declara.Order(CAT_INST_FINANCIERA.Properties.V_INSTITUCION));
                oInstitucion.select();
                ...
                cmbNID_TIPO_ADEUDO.SelectedValue = "3";
        ...
        protected void cmbNID_PAIS_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            oEntidadFederativa.NID_PAIS = new Declara.IntegerFilter(NID_PAIS);
