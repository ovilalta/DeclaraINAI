<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdeudoModificaInicio.ascx.cs" Inherits="DeclaraINE.Formas.DeclaracionModificacion.AdeudoModificaInicio" %>
...
<table class="f">
    <tbody>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="cmbNID_TIPO_ADEUDO" Enabled="false" runat="server">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
