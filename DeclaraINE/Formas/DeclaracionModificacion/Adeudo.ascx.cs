...
namespace DeclaraINAI.Formas.DeclaracionModificacion
{
    public partial class Adeudo : System.Web.UI.UserControl
    {
        ...
        public String V_TIPO_ADEUDO
        {
            ...
            set
            {
                cmbNID_TIPO_ADEUDO.SelectedValue = value.ToString();
        ...
        public int NOM_DEPENDIENTE
        {
            get => Convert.ToInt32( chbDependietesInm.SelectedValue);
            set
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {              
                ...
                txtF_BAJA_C.StartDate = new DateTime(1900, 1, 1);
                txtF_BAJA_C.EndDate = DateTime.Today.AddDays(-1);
                try { cmbNID_TIPO_ADEUDO.SelectedValue = "0"; } catch { };
                this.txtF_BAJA.Text = System.DateTime.Now.ToString();
