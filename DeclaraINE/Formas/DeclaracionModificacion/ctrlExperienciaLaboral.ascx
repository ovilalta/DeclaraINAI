<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrlExperienciaLaboral.ascx.cs" Inherits="DeclaraINAI.Formas.DeclaracionModificacion.ctrlExperienciaLaboral" %>
