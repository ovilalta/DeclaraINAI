...
{
    internal class dal__l_PATRIMONIO_INVERSION : _dal_base_Declara
    {

     #region *** Atributos ***

        internal List<Declara_V2.MODELextended.PATRIMONIO_INVERSION> lista_PATRIMONIO_INVERSIONs { get; set; }
        internal List<MODELDeclara_V2.PATRIMONIO_INVERSION> base_PATRIMONIO_INVERSIONs { get; set; }
        ...
        protected IQueryable<Declara_V2.MODELextended.PATRIMONIO_INVERSION> query { get; set; }
        protected IQueryable<MODELDeclara_V2.PATRIMONIO_INVERSION> single_query { get; set; }
     ...
     #region *** Constructores ***
        ...
        internal dal__l_PATRIMONIO_INVERSION()
        {
     ...
     #region *** Metodos ***
      ...
      protected void Single_Select()
        {
            single_query = from p in db.PATRIMONIO_INVERSION
                           select p;
        }
        ...
        protected void Select()
        {
            ...
            query = from qPATRIMONIO_INVERSION in db.PATRIMONIO_INVERSION
                    join qCAT_ENTIDAD_FEDERATIVA in db.CAT_ENTIDAD_FEDERATIVA on new { qPATRIMONIO_INVERSION.NID_PAIS, qPATRIMONIO_INVERSION.CID_ENTIDAD_FEDERATIVA }
                                                                          equals new { qCAT_ENTIDAD_FEDERATIVA.NID_PAIS, qCAT_ENTIDAD_FEDERATIVA.CID_ENTIDAD_FEDERATIVA }
                    join qCAT_INST_FINANCIERA in db.CAT_INST_FINANCIERA on qPATRIMONIO_INVERSION.NID_INSTITUCION
                                                                    equals qCAT_INST_FINANCIERA.NID_INSTITUCION
                    join qCAT_SUBTIPO_INVERSION in db.CAT_SUBTIPO_INVERSION on new { qPATRIMONIO_INVERSION.NID_TIPO_INVERSION, qPATRIMONIO_INVERSION.NID_SUBTIPO_INVERSION }
                                                                        equals new { qCAT_SUBTIPO_INVERSION.NID_TIPO_INVERSION, qCAT_SUBTIPO_INVERSION.NID_SUBTIPO_INVERSION }
                    join qPATRIMONIO in db.PATRIMONIO on new { qPATRIMONIO_INVERSION.VID_NOMBRE, qPATRIMONIO_INVERSION.VID_FECHA, qPATRIMONIO_INVERSION.VID_HOMOCLAVE, qPATRIMONIO_INVERSION.NID_PATRIMONIO }
                                                  equals new { qPATRIMONIO.VID_NOMBRE, qPATRIMONIO.VID_FECHA, qPATRIMONIO.VID_HOMOCLAVE, qPATRIMONIO.NID_PATRIMONIO }
                    select new Declara_V2.MODELextended.PATRIMONIO_INVERSION
                    {
                        VID_NOMBRE = qPATRIMONIO_INVERSION.VID_NOMBRE,
                        VID_FECHA = qPATRIMONIO_INVERSION.VID_FECHA,
                        VID_HOMOCLAVE = qPATRIMONIO_INVERSION.VID_HOMOCLAVE,
                        NID_PATRIMONIO = qPATRIMONIO_INVERSION.NID_PATRIMONIO,
                        NID_TIPO_INVERSION = qPATRIMONIO_INVERSION.NID_TIPO_INVERSION,
                        NID_SUBTIPO_INVERSION = qPATRIMONIO_INVERSION.NID_SUBTIPO_INVERSION,
                        NID_INSTITUCION = qPATRIMONIO_INVERSION.NID_INSTITUCION,
                        E_CUENTA = qPATRIMONIO_INVERSION.E_CUENTA,
                        V_CUENTA_CORTO = qPATRIMONIO_INVERSION.V_CUENTA_CORTO,
                        V_OTRO = qPATRIMONIO_INVERSION.V_OTRO,
                        M_SALDO = qPATRIMONIO_INVERSION.M_SALDO,
                        NID_PAIS = qPATRIMONIO_INVERSION.NID_PAIS,
                        CID_ENTIDAD_FEDERATIVA = qPATRIMONIO_INVERSION.CID_ENTIDAD_FEDERATIVA,
                        V_LUGAR = qPATRIMONIO_INVERSION.V_LUGAR,
        ...
        protected void Single_Where()
        {
            ...
            single_query = StringFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(VID_NOMBRE, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.VID_NOMBRE.ToString(), single_query);
            ...
            single_query = StringFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(VID_FECHA, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.VID_FECHA.ToString(), single_query);
            ...
            single_query = StringFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(VID_HOMOCLAVE, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.VID_HOMOCLAVE.ToString(), single_query);
            ...
            single_query = IntegerFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(NID_PATRIMONIO, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.NID_PATRIMONIO.ToString(), single_query);
            ...
            single_query = IntegerFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(NID_TIPO_INVERSION, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.NID_TIPO_INVERSION.ToString(), single_query);
            ...
            single_query = IntegerFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(NID_SUBTIPO_INVERSION, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.NID_SUBTIPO_INVERSION.ToString(), single_query);
            ...
            single_query = IntegerFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(NID_INSTITUCION, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.NID_INSTITUCION.ToString(), single_query);
            ...
            single_query = StringFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(E_CUENTA, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.E_CUENTA.ToString(), single_query);
            ...
            single_query = StringFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(V_CUENTA_CORTO, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.V_CUENTA_CORTO.ToString(), single_query);
            ...
            single_query = StringFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(V_OTRO, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.V_OTRO.ToString(), single_query);

            single_query = DecimalFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(M_SALDO, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.M_SALDO.ToString(), single_query);
            ...
            single_query = IntegerFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(NID_PAIS, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.NID_PAIS.ToString(), single_query);
            ...
            single_query = StringFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(CID_ENTIDAD_FEDERATIVA, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.CID_ENTIDAD_FEDERATIVA.ToString(), single_query);
            ...
            single_query = StringFilterBuilder<MODELDeclara_V2.PATRIMONIO_INVERSION>(V_LUGAR, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.V_LUGAR.ToString(), single_query);
        ...
        protected void Where()
        {
            ...
            query = StringFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(VID_NOMBRE, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.VID_NOMBRE.ToString(), query);
            ...
            query = StringFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(VID_FECHA, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.VID_FECHA.ToString(), query);
            ...
            query = StringFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(VID_HOMOCLAVE, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.VID_HOMOCLAVE.ToString(), query);
            ...
            query = IntegerFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(NID_PATRIMONIO, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.NID_PATRIMONIO.ToString(), query);
            ...
            query = IntegerFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(NID_TIPO_INVERSION, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.NID_TIPO_INVERSION.ToString(), query);
            ...
            query = IntegerFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(NID_SUBTIPO_INVERSION, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.NID_SUBTIPO_INVERSION.ToString(), query);
            ...
            query = IntegerFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(NID_INSTITUCION, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.NID_INSTITUCION.ToString(), query);
            ...
            query = StringFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(E_CUENTA, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.E_CUENTA.ToString(), query);
            ...
            query = StringFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(V_CUENTA_CORTO, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.V_CUENTA_CORTO.ToString(), query);
            ...
            query = StringFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(V_OTRO, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.V_OTRO.ToString(), query);

            query = DecimalFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(M_SALDO, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.M_SALDO.ToString(), query);
            ...
            query = IntegerFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(NID_PAIS, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.NID_PAIS.ToString(), query);
            ...
            query = StringFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(CID_ENTIDAD_FEDERATIVA, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.CID_ENTIDAD_FEDERATIVA.ToString(), query);
            ...
            query = StringFilterBuilder<Declara_V2.MODELextended.PATRIMONIO_INVERSION>(V_LUGAR, Declara_V2.MODELextended.PATRIMONIO_INVERSION.Properties.V_LUGAR.ToString(), query);
        ...
        protected void Single_Exec()
        {
            if (single_query.Any())
            {
                base_PATRIMONIO_INVERSIONs = single_query.AsNoTracking().ToList();
            }
            else
            {
                base_PATRIMONIO_INVERSIONs = new List<MODELDeclara_V2.PATRIMONIO_INVERSION>();
            }
        }
        ...
        protected void Exec()
        {
            if (query.Any())
            {
                lista_PATRIMONIO_INVERSIONs = query.AsNoTracking().ToList();
            }
            else
            {
                lista_PATRIMONIO_INVERSIONs = new List<Declara_V2.MODELextended.PATRIMONIO_INVERSION>();
            }
        }
  ...
  internal void Single_OrderBy()
        {
            ...
            {
                IOrderedQueryable<MODELDeclara_V2.PATRIMONIO_INVERSION> r;
        ...
        internal void orderBy()
        {
            if (OrderByCriterios.Count() > 0)
            {
                IOrderedQueryable<Declara_V2.MODELextended.PATRIMONIO_INVERSION> r;
                if (OrderByCriterios[0].OrderDirection == Order.OrderDirections.asc)
