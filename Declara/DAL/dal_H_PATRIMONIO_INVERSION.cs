...
{
    internal class dal_H_PATRIMONIO_INVERSION : _dal_base_Declara
    {

        H_PATRIMONIO_INVERSION registro;
     ...
     #region *** Constructores ***
        ...
        internal dal_H_PATRIMONIO_INVERSION() => registro = new H_PATRIMONIO_INVERSION();

        internal dal_H_PATRIMONIO_INVERSION(H_PATRIMONIO_INVERSION oH_PATRIMONIO_INVERSION) : this(oH_PATRIMONIO_INVERSION.VID_NOMBRE, oH_PATRIMONIO_INVERSION.VID_FECHA, oH_PATRIMONIO_INVERSION.VID_HOMOCLAVE, oH_PATRIMONIO_INVERSION.NID_PATRIMONIO, oH_PATRIMONIO_INVERSION.NID_HISTORICO) { }

        internal dal_H_PATRIMONIO_INVERSION(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_PATRIMONIO, Int32 NID_HISTORICO) { registro = db.H_PATRIMONIO_INVERSION.Find(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_PATRIMONIO, NID_HISTORICO); if (registro == null) throw new RowNotFoundException(); }

        internal dal_H_PATRIMONIO_INVERSION(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_PATRIMONIO, Int32 NID_HISTORICO, Int32 NID_TIPO_INVERSION, Int32 NID_SUBTIPO_INVERSION, Int32 NID_INSTITUCION, String E_CUENTA, String V_CUENTA_CORTO, String V_OTRO, Decimal M_SALDO, Int32 NID_PAIS, String CID_ENTIDAD_FEDERATIVA, String V_LUGAR, ExistingPrimaryKeyException.ExistingPrimaryKeyConditions lOpcionesRegistroExistente)
        {
               registro = new H_PATRIMONIO_INVERSION()
               {
            ...
            try
            {
                H_PATRIMONIO_INVERSION registroCheck = db.H_PATRIMONIO_INVERSION.Find(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_PATRIMONIO, NID_HISTORICO);
                switch (lOpcionesRegistroExistente)
                {
                    //Arrojar Exepción de llave primaria
                    case ExistingPrimaryKeyException.ExistingPrimaryKeyConditions.ThrowException:
                        if (registroCheck == null) insert();
                        else throw new ExistingPrimaryKeyException("H_PATRIMONIO_INVERSION",VID_NOMBRE + ", " + VID_FECHA + ", " + VID_HOMOCLAVE + ", " + NID_PATRIMONIO.ToString() + ", " + NID_HISTORICO.ToString() + ", " );
                        break;
                    ...
                    case ExistingPrimaryKeyException.ExistingPrimaryKeyConditions.UpdateExisiting:
                        ...
                        {
                            db.H_PATRIMONIO_INVERSION.Attach(registro);
     ...
     #region *** Metodos ***
        ...
        {
            db.H_PATRIMONIO_INVERSION.Add(registro);
            SaveChanges(true);
        }
        ...
        {
            db.H_PATRIMONIO_INVERSION.Remove(registro);
            SaveChanges(null);
