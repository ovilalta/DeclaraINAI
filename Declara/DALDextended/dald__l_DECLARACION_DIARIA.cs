...
{
    internal class dald__l_DECLARACION_DIARIA : dal__l_DECLARACION_DIARIA
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_DECLARACION_DIARIAs != null)
                    {
                        return lista_DECLARACION_DIARIAs.Count;
                    }
                    else
                    {
                        return lista_DECLARACION_DIARIAs.Count;
        ...
        internal dald__l_DECLARACION_DIARIA()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
