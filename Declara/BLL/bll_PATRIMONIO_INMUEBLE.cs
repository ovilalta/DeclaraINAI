...
{
    public  class bll_PATRIMONIO_INMUEBLE : _bllSistema
    {

        internal dald_PATRIMONIO_INMUEBLE datos_PATRIMONIO_INMUEBLE;
     ...
     #region *** Atributos ***
        ...
        [DisplayName("")]
        public String VID_NOMBRE => datos_PATRIMONIO_INMUEBLE.VID_NOMBRE;

        [Key]
        [StringLength(6)]
        [Required(ErrorMessage = "El campo  es requerido ")]
        [DisplayName("")]
        public String VID_FECHA => datos_PATRIMONIO_INMUEBLE.VID_FECHA;

        [Key]
        [StringLength(3)]
        [Required(ErrorMessage = "El campo  es requerido ")]
        [DisplayName("")]
        public String VID_HOMOCLAVE => datos_PATRIMONIO_INMUEBLE.VID_HOMOCLAVE;

        [Key]
        [Required(ErrorMessage = "El campo  es requerido ")]
        [DisplayName("")]
        public Int32 NID_PATRIMONIO => datos_PATRIMONIO_INMUEBLE.NID_PATRIMONIO;
        ...
        {
            get { return datos_PATRIMONIO_INMUEBLE.lEsNuevoRegistro; }
        }
     ...
     #region *** Constructores ***
        ...
        public bll_PATRIMONIO_INMUEBLE() => datos_PATRIMONIO_INMUEBLE = new dald_PATRIMONIO_INMUEBLE();

        public bll_PATRIMONIO_INMUEBLE(MODELDeclara_V2.PATRIMONIO_INMUEBLE PATRIMONIO_INMUEBLE) => datos_PATRIMONIO_INMUEBLE = new dald_PATRIMONIO_INMUEBLE(PATRIMONIO_INMUEBLE);

        public bll_PATRIMONIO_INMUEBLE(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_PATRIMONIO) => datos_PATRIMONIO_INMUEBLE = new dald_PATRIMONIO_INMUEBLE(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_PATRIMONIO);

        public bll_PATRIMONIO_INMUEBLE(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_PATRIMONIO, Int32 NID_TIPO, DateTime F_ADQUISICION, Int32 NID_USO, String E_UBICACION, Decimal N_TERRENO, Decimal N_CONSTRUCCION, Decimal M_VALOR_INMUEBLE, ExistingPrimaryKeyException.ExistingPrimaryKeyConditions lOpcionesRegistroExistente) => datos_PATRIMONIO_INMUEBLE = new dald_PATRIMONIO_INMUEBLE(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_PATRIMONIO, NID_TIPO, F_ADQUISICION, NID_USO, E_UBICACION, N_TERRENO, N_CONSTRUCCION, M_VALOR_INMUEBLE, lOpcionesRegistroExistente);
     ...
     #region *** Metodos ***
        ...
        public void update()
        {
            datos_PATRIMONIO_INMUEBLE.update();
        }

        public void delete()
        {
            datos_PATRIMONIO_INMUEBLE.delete();
        }

        public void reload()
        {
            datos_PATRIMONIO_INMUEBLE.reload();
        }
