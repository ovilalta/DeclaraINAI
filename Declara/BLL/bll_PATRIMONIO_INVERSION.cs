...
{
    public  class bll_PATRIMONIO_INVERSION : _bllSistema
    {

        internal dald_PATRIMONIO_INVERSION datos_PATRIMONIO_INVERSION;
     ...
     #region *** Atributos ***
        ...
        [DisplayName("")]
        public String VID_NOMBRE => datos_PATRIMONIO_INVERSION.VID_NOMBRE;

        [Key]
        [StringLength(6)]
        [Required(ErrorMessage = "El campo  es requerido ")]
        [DisplayName("")]
        public String VID_FECHA => datos_PATRIMONIO_INVERSION.VID_FECHA;

        [Key]
        [StringLength(3)]
        [Required(ErrorMessage = "El campo  es requerido ")]
        [DisplayName("")]
        public String VID_HOMOCLAVE => datos_PATRIMONIO_INVERSION.VID_HOMOCLAVE;

        [Key]
        [Required(ErrorMessage = "El campo  es requerido ")]
        [DisplayName("")]
        public Int32 NID_PATRIMONIO => datos_PATRIMONIO_INVERSION.NID_PATRIMONIO;
        ...
        {
            get { return datos_PATRIMONIO_INVERSION.lEsNuevoRegistro; }
        }
     ...
     #region *** Constructores ***
        ...
        public bll_PATRIMONIO_INVERSION() => datos_PATRIMONIO_INVERSION = new dald_PATRIMONIO_INVERSION();

        public bll_PATRIMONIO_INVERSION(MODELDeclara_V2.PATRIMONIO_INVERSION PATRIMONIO_INVERSION) => datos_PATRIMONIO_INVERSION = new dald_PATRIMONIO_INVERSION(PATRIMONIO_INVERSION);

        public bll_PATRIMONIO_INVERSION(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_PATRIMONIO) => datos_PATRIMONIO_INVERSION = new dald_PATRIMONIO_INVERSION(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_PATRIMONIO);

        public bll_PATRIMONIO_INVERSION(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_PATRIMONIO, Int32 NID_TIPO_INVERSION, Int32 NID_SUBTIPO_INVERSION, Int32 NID_INSTITUCION, String E_CUENTA, String V_CUENTA_CORTO, String V_OTRO, Decimal M_SALDO, Int32 NID_PAIS, String CID_ENTIDAD_FEDERATIVA, String V_LUGAR, ExistingPrimaryKeyException.ExistingPrimaryKeyConditions lOpcionesRegistroExistente) => datos_PATRIMONIO_INVERSION = new dald_PATRIMONIO_INVERSION(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_PATRIMONIO, NID_TIPO_INVERSION, NID_SUBTIPO_INVERSION, NID_INSTITUCION, E_CUENTA, V_CUENTA_CORTO, V_OTRO, M_SALDO, NID_PAIS, CID_ENTIDAD_FEDERATIVA, V_LUGAR, lOpcionesRegistroExistente);
     ...
     #region *** Metodos ***
        ...
        public void update()
        {
            datos_PATRIMONIO_INVERSION.update();
        }

        public void delete()
        {
            datos_PATRIMONIO_INVERSION.delete();
        }

        public void reload()
        {
            datos_PATRIMONIO_INVERSION.reload();
        }
