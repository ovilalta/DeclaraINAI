...
{
    internal class dald__l_CAT_BIEN_ENAJENADO : dal__l_CAT_BIEN_ENAJENADO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_BIEN_ENAJENADOs != null)
                    {
                        return lista_CAT_BIEN_ENAJENADOs.Count;
                    }
                    else
                    {
                        return base_CAT_BIEN_ENAJENADOs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_CAT_BIEN_ENAJENADO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_CAT_BIEN_ENAJENADOs = null;
            base.Single_Select();
            base.Single_Where();
