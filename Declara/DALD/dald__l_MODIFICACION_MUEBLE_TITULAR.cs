...
{
    internal class dald__l_MODIFICACION_MUEBLE_TITULAR : dal__l_MODIFICACION_MUEBLE_TITULAR
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_MUEBLE_TITULARs != null)
                    {
                        return lista_MODIFICACION_MUEBLE_TITULARs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_MUEBLE_TITULARs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_MUEBLE_TITULAR()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_MUEBLE_TITULARs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_MODIFICACION_MUEBLE_TITULARs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
