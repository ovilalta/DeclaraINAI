...
{
    internal class dald__l_PATRIMONIO_FLUJO : dal__l_PATRIMONIO_FLUJO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_PATRIMONIO_FLUJOs != null)
                    {
                        return lista_PATRIMONIO_FLUJOs.Count;
                    }
                    else
                    {
                        return base_PATRIMONIO_FLUJOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_PATRIMONIO_FLUJO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
