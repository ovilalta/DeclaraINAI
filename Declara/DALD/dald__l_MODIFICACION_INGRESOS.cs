...
{
    internal class dald__l_MODIFICACION_INGRESOS : dal__l_MODIFICACION_INGRESOS
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_INGRESOSs != null)
                    {
                        return lista_MODIFICACION_INGRESOSs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_INGRESOSs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_INGRESOS()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_INGRESOSs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_MODIFICACION_INGRESOSs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
