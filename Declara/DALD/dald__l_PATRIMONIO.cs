...
{
    internal class dald__l_PATRIMONIO : dal__l_PATRIMONIO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                else
                {
                    ...
                    {
                        return lista_PATRIMONIOs.Count;
                    }
                    else
                    {
                        return base_PATRIMONIOs.Count;
                    }
                }
            }
        }
