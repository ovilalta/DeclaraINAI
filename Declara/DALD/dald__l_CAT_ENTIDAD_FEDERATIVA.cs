...
{
    internal class dald__l_CAT_ENTIDAD_FEDERATIVA : dal__l_CAT_ENTIDAD_FEDERATIVA
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_ENTIDAD_FEDERATIVAs != null)
                    {
                        return lista_CAT_ENTIDAD_FEDERATIVAs.Count;
                    }
                    else
                    {
                        return base_CAT_ENTIDAD_FEDERATIVAs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_ENTIDAD_FEDERATIVA()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_ENTIDAD_FEDERATIVAs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_ENTIDAD_FEDERATIVAs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
