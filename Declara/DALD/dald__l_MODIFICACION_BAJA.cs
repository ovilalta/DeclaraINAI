...
{
    internal class dald__l_MODIFICACION_BAJA : dal__l_MODIFICACION_BAJA
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_BAJAs != null)
                    {
                        return lista_MODIFICACION_BAJAs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_BAJAs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_BAJA()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
