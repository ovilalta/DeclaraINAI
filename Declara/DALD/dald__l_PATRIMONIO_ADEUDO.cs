...
{
    internal class dald__l_PATRIMONIO_ADEUDO : dal__l_PATRIMONIO_ADEUDO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_PATRIMONIO_ADEUDOs != null)
                    {
                        return lista_PATRIMONIO_ADEUDOs.Count;
                    }
                    else
                    {
                        return base_PATRIMONIO_ADEUDOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_PATRIMONIO_ADEUDO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
