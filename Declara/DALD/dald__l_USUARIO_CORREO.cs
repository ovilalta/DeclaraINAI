...
{
    internal class dald__l_USUARIO_CORREO : dal__l_USUARIO_CORREO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_USUARIO_CORREOs != null)
                    {
                        return lista_USUARIO_CORREOs.Count;
                    }
                    else
                    {
                        return base_USUARIO_CORREOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_USUARIO_CORREO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
