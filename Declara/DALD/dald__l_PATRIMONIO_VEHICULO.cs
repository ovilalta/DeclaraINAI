...
{
    internal class dald__l_PATRIMONIO_VEHICULO : dal__l_PATRIMONIO_VEHICULO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_PATRIMONIO_VEHICULOs != null)
                    {
                        return lista_PATRIMONIO_VEHICULOs.Count;
                    }
                    else
                    {
                        return base_PATRIMONIO_VEHICULOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_PATRIMONIO_VEHICULO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_PATRIMONIO_VEHICULOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_PATRIMONIO_VEHICULOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
