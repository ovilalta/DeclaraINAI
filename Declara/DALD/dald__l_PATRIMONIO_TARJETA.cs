...
{
    internal class dald__l_PATRIMONIO_TARJETA : dal__l_PATRIMONIO_TARJETA
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_PATRIMONIO_TARJETAs != null)
                    {
                        return lista_PATRIMONIO_TARJETAs.Count;
                    }
                    else
                    {
                        return base_PATRIMONIO_TARJETAs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_PATRIMONIO_TARJETA()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_PATRIMONIO_TARJETAs = null;
            base.Single_Select();
            base.Single_Where();
