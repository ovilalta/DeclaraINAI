...
{
    internal class dald__l_DECLARACION : dal__l_DECLARACION
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_DECLARACIONs != null)
                    {
                        return lista_DECLARACIONs.Count;
                    }
                    else
                    {
                        return base_DECLARACIONs.Count;
                    }
                }
            }
        }
