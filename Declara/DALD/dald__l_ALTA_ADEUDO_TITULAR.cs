...
{
    internal class dald__l_ALTA_ADEUDO_TITULAR : dal__l_ALTA_ADEUDO_TITULAR
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_ALTA_ADEUDO_TITULARs != null)
                    {
                        return lista_ALTA_ADEUDO_TITULARs.Count;
                    }
                    else
                    {
                        return base_ALTA_ADEUDO_TITULARs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_ALTA_ADEUDO_TITULAR()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_ALTA_ADEUDO_TITULARs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_ALTA_ADEUDO_TITULARs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
