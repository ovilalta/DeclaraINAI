...
{
    internal class dald__l_MODIFICACION_INMUEBLE_ADEUDO : dal__l_MODIFICACION_INMUEBLE_ADEUDO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_INMUEBLE_ADEUDOs != null)
                    {
                        return lista_MODIFICACION_INMUEBLE_ADEUDOs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_INMUEBLE_ADEUDOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_INMUEBLE_ADEUDO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_INMUEBLE_ADEUDOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_MODIFICACION_INMUEBLE_ADEUDOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
