...
{
    internal class dald__l_H_PATRIMONIO_INMUEBLE : dal__l_H_PATRIMONIO_INMUEBLE
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_H_PATRIMONIO_INMUEBLEs != null)
                    {
                        return lista_H_PATRIMONIO_INMUEBLEs.Count;
                    }
                    else
                    {
                        return base_H_PATRIMONIO_INMUEBLEs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_H_PATRIMONIO_INMUEBLE()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_H_PATRIMONIO_INMUEBLEs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_H_PATRIMONIO_INMUEBLEs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
