...
{
    internal class dald__l_CAT_FORMA_ADQUISICION : dal__l_CAT_FORMA_ADQUISICION
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_FORMA_ADQUISICIONs != null)
                    {
                        return lista_CAT_FORMA_ADQUISICIONs.Count;
                    }
                    else
                    {
                        return base_CAT_FORMA_ADQUISICIONs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_CAT_FORMA_ADQUISICION()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_CAT_FORMA_ADQUISICIONs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_FORMA_ADQUISICIONs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
