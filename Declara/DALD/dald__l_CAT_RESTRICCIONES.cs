...
{
    internal class dald__l_CAT_RESTRICCIONES : dal__l_CAT_RESTRICCIONES
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_RESTRICCIONESs != null)
                    {
                        return lista_CAT_RESTRICCIONESs.Count;
                    }
                    else
                    {
                        return base_CAT_RESTRICCIONESs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_RESTRICCIONES()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
