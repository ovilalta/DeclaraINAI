...
{
    internal class dald__l_ALTA_COMODATO_INMUEBLE : dal__l_ALTA_COMODATO_INMUEBLE
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_ALTA_COMODATO_INMUEBLEs != null)
                    {
                        return lista_ALTA_COMODATO_INMUEBLEs.Count;
                    }
                    else
                    {
                        return base_ALTA_COMODATO_INMUEBLEs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_ALTA_COMODATO_INMUEBLE()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_ALTA_COMODATO_INMUEBLEs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_ALTA_COMODATO_INMUEBLEs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
