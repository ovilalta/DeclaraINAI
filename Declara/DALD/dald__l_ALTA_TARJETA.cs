...
{
    internal class dald__l_ALTA_TARJETA : dal__l_ALTA_TARJETA
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_ALTA_TARJETAs != null)
                    {
                        return lista_ALTA_TARJETAs.Count;
                    }
                    else
                    {
                        return base_ALTA_TARJETAs.Count;
                    }
                }
            }
        }
