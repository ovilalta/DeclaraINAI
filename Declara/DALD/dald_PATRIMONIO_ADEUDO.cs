...
{
    internal partial class dald_PATRIMONIO_ADEUDO : dal_PATRIMONIO_ADEUDO
    {
     ...
     #region *** Constructores ***
        ...
        internal dald_PATRIMONIO_ADEUDO()
        : base() { }

        internal dald_PATRIMONIO_ADEUDO(PATRIMONIO_ADEUDO PATRIMONIO_ADEUDO)
        : base(PATRIMONIO_ADEUDO) { }

        internal dald_PATRIMONIO_ADEUDO(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_PATRIMONIO)
        : base(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_PATRIMONIO) { }

        public dald_PATRIMONIO_ADEUDO(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_PATRIMONIO, Int32 NID_PAIS, String CID_ENTIDAD_FEDERATIVA, String V_LUGAR, Int32 NID_INSTITUCION, String V_OTRA, Int32 NID_TIPO_ADEUDO, Decimal M_ORIGINAL, Decimal M_SALDO, String E_CUENTA, ExistingPrimaryKeyException.ExistingPrimaryKeyConditions lOpcionesRegistroExistente)
        : base(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_PATRIMONIO, NID_PAIS, CID_ENTIDAD_FEDERATIVA, V_LUGAR, NID_INSTITUCION, V_OTRA, NID_TIPO_ADEUDO, M_ORIGINAL, M_SALDO, E_CUENTA, lOpcionesRegistroExistente)  { }
