...
{
    internal class dald__l_CAT_TIPO_VEHICULO : dal__l_CAT_TIPO_VEHICULO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_TIPO_VEHICULOs != null)
                    {
                        return lista_CAT_TIPO_VEHICULOs.Count;
                    }
                    else
                    {
                        return base_CAT_TIPO_VEHICULOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_TIPO_VEHICULO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
