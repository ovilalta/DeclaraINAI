...
{
    internal class dald__l_CAT_AMBITO_SECTOR : dal__l_CAT_AMBITO_SECTOR
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_AMBITO_SECTORs != null)
                    {
                        return lista_CAT_AMBITO_SECTORs.Count;
                    }
                    else
                    {
                        return base_CAT_AMBITO_SECTORs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_CAT_AMBITO_SECTOR()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
