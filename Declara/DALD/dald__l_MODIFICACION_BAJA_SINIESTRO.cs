...
{
    internal class dald__l_MODIFICACION_BAJA_SINIESTRO : dal__l_MODIFICACION_BAJA_SINIESTRO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_BAJA_SINIESTROs != null)
                    {
                        return lista_MODIFICACION_BAJA_SINIESTROs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_BAJA_SINIESTROs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_BAJA_SINIESTRO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_BAJA_SINIESTROs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_MODIFICACION_BAJA_SINIESTROs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
