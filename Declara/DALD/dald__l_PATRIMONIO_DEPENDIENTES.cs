...
{
    internal class dald__l_PATRIMONIO_DEPENDIENTES : dal__l_PATRIMONIO_DEPENDIENTES
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_PATRIMONIO_DEPENDIENTESs != null)
                    {
                        return lista_PATRIMONIO_DEPENDIENTESs.Count;
                    }
                    else
                    {
                        return base_PATRIMONIO_DEPENDIENTESs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_PATRIMONIO_DEPENDIENTES()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_PATRIMONIO_DEPENDIENTESs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_PATRIMONIO_DEPENDIENTESs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
