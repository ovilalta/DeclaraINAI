...
{
    internal class dald__l_CONFLICTO_RUBRO : dal__l_CONFLICTO_RUBRO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CONFLICTO_RUBROs != null)
                    {
                        return lista_CONFLICTO_RUBROs.Count;
                    }
                    else
                    {
                        return base_CONFLICTO_RUBROs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CONFLICTO_RUBRO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
