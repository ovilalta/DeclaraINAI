...
{
    internal partial class dald_PATRIMONIO_VEHICULO : dal_PATRIMONIO_VEHICULO
    {
     ...
     #region *** Constructores ***
        ...
        internal dald_PATRIMONIO_VEHICULO()
        : base() { }

        internal dald_PATRIMONIO_VEHICULO(PATRIMONIO_VEHICULO PATRIMONIO_VEHICULO)
        : base(PATRIMONIO_VEHICULO) { }

        internal dald_PATRIMONIO_VEHICULO(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_PATRIMONIO)
        : base(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_PATRIMONIO) { }

        public dald_PATRIMONIO_VEHICULO(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_PATRIMONIO, Int32 NID_MARCA, String C_MODELO, String V_DESCRIPCION, DateTime F_ADQUISICION, Int32 NID_USO, Decimal M_VALOR_VEHICULO, ExistingPrimaryKeyException.ExistingPrimaryKeyConditions lOpcionesRegistroExistente)
        : base(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_PATRIMONIO, NID_MARCA, C_MODELO, V_DESCRIPCION, F_ADQUISICION, NID_USO, M_VALOR_VEHICULO, lOpcionesRegistroExistente)  { }
