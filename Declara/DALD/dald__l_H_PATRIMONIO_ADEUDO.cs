...
{
    internal class dald__l_H_PATRIMONIO_ADEUDO : dal__l_H_PATRIMONIO_ADEUDO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_H_PATRIMONIO_ADEUDOs != null)
                    {
                        return lista_H_PATRIMONIO_ADEUDOs.Count;
                    }
                    else
                    {
                        return base_H_PATRIMONIO_ADEUDOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_H_PATRIMONIO_ADEUDO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_H_PATRIMONIO_ADEUDOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_H_PATRIMONIO_ADEUDOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
