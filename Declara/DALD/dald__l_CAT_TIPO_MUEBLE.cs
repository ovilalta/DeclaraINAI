...
{
    internal class dald__l_CAT_TIPO_MUEBLE : dal__l_CAT_TIPO_MUEBLE
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_TIPO_MUEBLEs != null)
                    {
                        return lista_CAT_TIPO_MUEBLEs.Count;
                    }
                    else
                    {
                        return base_CAT_TIPO_MUEBLEs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_TIPO_MUEBLE()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
