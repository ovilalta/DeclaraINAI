...
{
    internal class dald__l_PATRIMONIO_INVERSION : dal__l_PATRIMONIO_INVERSION
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_PATRIMONIO_INVERSIONs != null)
                    {
                        return lista_PATRIMONIO_INVERSIONs.Count;
                    }
                    else
                    {
                        return base_PATRIMONIO_INVERSIONs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_PATRIMONIO_INVERSION()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_PATRIMONIO_INVERSIONs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_PATRIMONIO_INVERSIONs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
