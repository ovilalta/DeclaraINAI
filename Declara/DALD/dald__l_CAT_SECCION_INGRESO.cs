...
{
    internal class dald__l_CAT_SECCION_INGRESO : dal__l_CAT_SECCION_INGRESO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_SECCION_INGRESOs != null)
                    {
                        return lista_CAT_SECCION_INGRESOs.Count;
                    }
                    else
                    {
                        return base_CAT_SECCION_INGRESOs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_CAT_SECCION_INGRESO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_CAT_SECCION_INGRESOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_SECCION_INGRESOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
