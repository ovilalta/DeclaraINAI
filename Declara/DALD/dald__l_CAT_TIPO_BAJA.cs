...
{
    internal class dald__l_CAT_TIPO_BAJA : dal__l_CAT_TIPO_BAJA
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_TIPO_BAJAs != null)
                    {
                        return lista_CAT_TIPO_BAJAs.Count;
                    }
                    else
                    {
                        return base_CAT_TIPO_BAJAs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_TIPO_BAJA()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
