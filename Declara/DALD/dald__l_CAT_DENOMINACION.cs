...
{
    internal class dald__l_CAT_DENOMINACION : dal__l_CAT_DENOMINACION
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_DENOMINACIONs != null)
                    {
                        return lista_CAT_DENOMINACIONs.Count;
                    }
                    else
                    {
                        return base_CAT_DENOMINACIONs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_DENOMINACION()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
