...
{
    internal class dald__l_MODIFICACION_DONACION : dal__l_MODIFICACION_DONACION
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_DONACIONs != null)
                    {
                        return lista_MODIFICACION_DONACIONs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_DONACIONs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_DONACION()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_DONACIONs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_MODIFICACION_DONACIONs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
