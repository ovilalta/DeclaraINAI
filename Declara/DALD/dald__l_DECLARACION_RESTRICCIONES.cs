...
{
    internal class dald__l_DECLARACION_RESTRICCIONES : dal__l_DECLARACION_RESTRICCIONES
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_DECLARACION_RESTRICCIONESs != null)
                    {
                        return lista_DECLARACION_RESTRICCIONESs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_RESTRICCIONESs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_DECLARACION_RESTRICCIONES()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_DECLARACION_RESTRICCIONESs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_RESTRICCIONESs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
