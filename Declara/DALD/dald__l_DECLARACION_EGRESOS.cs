...
{
    internal class dald__l_DECLARACION_EGRESOS : dal__l_DECLARACION_EGRESOS
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_DECLARACION_EGRESOSs != null)
                    {
                        return lista_DECLARACION_EGRESOSs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_EGRESOSs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_DECLARACION_EGRESOS()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_DECLARACION_EGRESOSs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_EGRESOSs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
