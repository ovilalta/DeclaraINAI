...
{
    internal class dald__l_CAT_TIPO_PATRIMONIO : dal__l_CAT_TIPO_PATRIMONIO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_TIPO_PATRIMONIOs != null)
                    {
                        return lista_CAT_TIPO_PATRIMONIOs.Count;
                    }
                    else
                    {
                        return base_CAT_TIPO_PATRIMONIOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_TIPO_PATRIMONIO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_TIPO_PATRIMONIOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_TIPO_PATRIMONIOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
