...
{
    internal class dald__l_CAT_ESTADO_CONFLICTO : dal__l_CAT_ESTADO_CONFLICTO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_ESTADO_CONFLICTOs != null)
                    {
                        return lista_CAT_ESTADO_CONFLICTOs.Count;
                    }
                    else
                    {
                        return base_CAT_ESTADO_CONFLICTOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_ESTADO_CONFLICTO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_ESTADO_CONFLICTOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_ESTADO_CONFLICTOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
