...
{
    internal class dald__l_H_PATRIMONIO_TITULAR : dal__l_H_PATRIMONIO_TITULAR
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_H_PATRIMONIO_TITULARs != null)
                    {
                        return lista_H_PATRIMONIO_TITULARs.Count;
                    }
                    else
                    {
                        return base_H_PATRIMONIO_TITULARs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_H_PATRIMONIO_TITULAR()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_H_PATRIMONIO_TITULARs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_H_PATRIMONIO_TITULARs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
