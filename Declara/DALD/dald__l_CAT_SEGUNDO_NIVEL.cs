...
{
    internal class dald__l_CAT_SEGUNDO_NIVEL : dal__l_CAT_SEGUNDO_NIVEL
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_SEGUNDO_NIVELs != null)
                    {
                        return lista_CAT_SEGUNDO_NIVELs.Count;
                    }
                    else
                    {
                        return base_CAT_SEGUNDO_NIVELs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_SEGUNDO_NIVEL()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
