...
{
    internal class dald__l_DECLARACION_DOM_PARTICULAR : dal__l_DECLARACION_DOM_PARTICULAR
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_DECLARACION_DOM_PARTICULARs != null)
                    {
                        return lista_DECLARACION_DOM_PARTICULARs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_DOM_PARTICULARs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_DECLARACION_DOM_PARTICULAR()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_DECLARACION_DOM_PARTICULARs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_DOM_PARTICULARs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
