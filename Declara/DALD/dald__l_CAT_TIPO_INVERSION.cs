...
{
    internal class dald__l_CAT_TIPO_INVERSION : dal__l_CAT_TIPO_INVERSION
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_TIPO_INVERSIONs != null)
                    {
                        return lista_CAT_TIPO_INVERSIONs.Count;
                    }
                    else
                    {
                        return base_CAT_TIPO_INVERSIONs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_TIPO_INVERSION()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_TIPO_INVERSIONs = null;
            base.Single_Select();
            base.Single_Where();
