...
{
    internal class dald__l_DECLARACION_REGIMEN_MATRIMONIAL : dal__l_DECLARACION_REGIMEN_MATRIMONIAL
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_DECLARACION_REGIMEN_MATRIMONIALs != null)
                    {
                        return lista_DECLARACION_REGIMEN_MATRIMONIALs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_REGIMEN_MATRIMONIALs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_DECLARACION_REGIMEN_MATRIMONIAL()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_DECLARACION_REGIMEN_MATRIMONIALs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_REGIMEN_MATRIMONIALs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
