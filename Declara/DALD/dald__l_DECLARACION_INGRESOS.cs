...
{
    internal class dald__l_DECLARACION_INGRESOS : dal__l_DECLARACION_INGRESOS
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_DECLARACION_INGRESOSs != null)
                    {
                        return lista_DECLARACION_INGRESOSs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_INGRESOSs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_DECLARACION_INGRESOS()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_DECLARACION_INGRESOSs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_INGRESOSs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
