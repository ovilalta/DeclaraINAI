...
{
    internal class dald__l_DECLARACION_ESCOLARIDAD : dal__l_DECLARACION_ESCOLARIDAD
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_DECLARACION_ESCOLARIDADs != null)
                    {
                        return lista_DECLARACION_ESCOLARIDADs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_ESCOLARIDADs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_DECLARACION_ESCOLARIDAD()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_DECLARACION_ESCOLARIDADs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_ESCOLARIDADs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
