...
{
    internal class dald__l_CONFLICTO_ENCABEZADO : dal__l_CONFLICTO_ENCABEZADO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CONFLICTO_ENCABEZADOs != null)
                    {
                        return lista_CONFLICTO_ENCABEZADOs.Count;
                    }
                    else
                    {
                        return base_CONFLICTO_ENCABEZADOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CONFLICTO_ENCABEZADO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CONFLICTO_ENCABEZADOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CONFLICTO_ENCABEZADOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
