...
{
    internal class dald__l_H_PATRIMONIO : dal__l_H_PATRIMONIO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_H_PATRIMONIOs != null)
                    {
                        return lista_H_PATRIMONIOs.Count;
                    }
                    else
                    {
                        return base_H_PATRIMONIOs.Count;
                    }
                }
            }
        }
