...
{
    internal class dald__l_DECLARACION_DEPENDIENTES : dal__l_DECLARACION_DEPENDIENTES
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_DECLARACION_DEPENDIENTESs != null)
                    {
                        return lista_DECLARACION_DEPENDIENTESs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_DEPENDIENTESs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_DECLARACION_DEPENDIENTES()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_DECLARACION_DEPENDIENTESs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_DEPENDIENTESs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
