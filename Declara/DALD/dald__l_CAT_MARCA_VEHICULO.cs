...
{
    internal class dald__l_CAT_MARCA_VEHICULO : dal__l_CAT_MARCA_VEHICULO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_MARCA_VEHICULOs != null)
                    {
                        return lista_CAT_MARCA_VEHICULOs.Count;
                    }
                    else
                    {
                        return base_CAT_MARCA_VEHICULOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_MARCA_VEHICULO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_MARCA_VEHICULOs = null;
            base.Single_Select();
            base.Single_Where();
