...
{
    internal class dald__l_CAT_TIPS : dal__l_CAT_TIPS
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_TIPSs != null)
                    {
                        return lista_CAT_TIPSs.Count;
                    }
                    else
                    {
                        return base_CAT_TIPSs.Count;
                    }
                }
            }
        }
