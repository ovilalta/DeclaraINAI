...
{
    internal class dald__l_CAT_INST_FINANCIERA : dal__l_CAT_INST_FINANCIERA
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_INST_FINANCIERAs != null)
                    {
                        return lista_CAT_INST_FINANCIERAs.Count;
                    }
                    else
                    {
                        return base_CAT_INST_FINANCIERAs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_INST_FINANCIERA()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_INST_FINANCIERAs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_INST_FINANCIERAs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
