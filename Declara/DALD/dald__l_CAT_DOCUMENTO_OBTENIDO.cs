...
{
    internal class dald__l_CAT_DOCUMENTO_OBTENIDO : dal__l_CAT_DOCUMENTO_OBTENIDO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_DOCUMENTO_OBTENIDOs != null)
                    {
                        return lista_CAT_DOCUMENTO_OBTENIDOs.Count;
                    }
                    else
                    {
                        return base_CAT_DOCUMENTO_OBTENIDOs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_CAT_DOCUMENTO_OBTENIDO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_CAT_DOCUMENTO_OBTENIDOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_DOCUMENTO_OBTENIDOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
