...
{
    internal partial class dald_PATRIMONIO_INMUEBLE : dal_PATRIMONIO_INMUEBLE
    {
     ...
     #region *** Constructores ***
        ...
        internal dald_PATRIMONIO_INMUEBLE()
        : base() { }

        internal dald_PATRIMONIO_INMUEBLE(PATRIMONIO_INMUEBLE PATRIMONIO_INMUEBLE)
        : base(PATRIMONIO_INMUEBLE) { }

        internal dald_PATRIMONIO_INMUEBLE(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_PATRIMONIO)
        : base(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_PATRIMONIO) { }

        public dald_PATRIMONIO_INMUEBLE(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_PATRIMONIO, Int32 NID_TIPO, DateTime F_ADQUISICION, Int32 NID_USO, String E_UBICACION, Decimal N_TERRENO, Decimal N_CONSTRUCCION, Decimal M_VALOR_INMUEBLE, ExistingPrimaryKeyException.ExistingPrimaryKeyConditions lOpcionesRegistroExistente)
        : base(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_PATRIMONIO, NID_TIPO, F_ADQUISICION, NID_USO, E_UBICACION, N_TERRENO, N_CONSTRUCCION, M_VALOR_INMUEBLE, lOpcionesRegistroExistente)  { }
