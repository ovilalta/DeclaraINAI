...
{
    internal class dald__l_CAT_PRIMER_NIVEL : dal__l_CAT_PRIMER_NIVEL
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_PRIMER_NIVELs != null)
                    {
                        return lista_CAT_PRIMER_NIVELs.Count;
                    }
                    else
                    {
                        return base_CAT_PRIMER_NIVELs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_PRIMER_NIVEL()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
