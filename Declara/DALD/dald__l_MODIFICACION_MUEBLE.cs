...
{
    internal class dald__l_MODIFICACION_MUEBLE : dal__l_MODIFICACION_MUEBLE
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_MUEBLEs != null)
                    {
                        return lista_MODIFICACION_MUEBLEs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_MUEBLEs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_MUEBLE()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_MUEBLEs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_MODIFICACION_MUEBLEs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
