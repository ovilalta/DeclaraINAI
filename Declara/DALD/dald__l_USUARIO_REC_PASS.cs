...
{
    internal class dald__l_USUARIO_REC_PASS : dal__l_USUARIO_REC_PASS
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_USUARIO_REC_PASSs != null)
                    {
                        return lista_USUARIO_REC_PASSs.Count;
                    }
                    else
                    {
                        return base_USUARIO_REC_PASSs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_USUARIO_REC_PASS()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
