...
{
    internal class dald__l_DECLARACION_EXPERIENCIA_LABORAL : dal__l_DECLARACION_EXPERIENCIA_LABORAL
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_DECLARACION_EXPERIENCIA_LABORALs != null)
                    {
                        return lista_DECLARACION_EXPERIENCIA_LABORALs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_EXPERIENCIA_LABORALs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_DECLARACION_EXPERIENCIA_LABORAL()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_DECLARACION_EXPERIENCIA_LABORALs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_EXPERIENCIA_LABORALs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
