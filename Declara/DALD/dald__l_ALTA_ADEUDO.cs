...
{
    internal class dald__l_ALTA_ADEUDO : dal__l_ALTA_ADEUDO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_ALTA_ADEUDOs != null)
                    {
                        return lista_ALTA_ADEUDOs.Count;
                    }
                    else
                    {
                        return base_ALTA_ADEUDOs.Count;
                    }
                }
            }
        }
