...
{
    internal class dald__l_DECLARACION_APARTADO : dal__l_DECLARACION_APARTADO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_DECLARACION_APARTADOs != null)
                    {
                        return lista_DECLARACION_APARTADOs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_APARTADOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_DECLARACION_APARTADO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_DECLARACION_APARTADOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_APARTADOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
