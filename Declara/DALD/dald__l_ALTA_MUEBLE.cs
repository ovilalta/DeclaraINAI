...
{
    internal class dald__l_ALTA_MUEBLE : dal__l_ALTA_MUEBLE
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_ALTA_MUEBLEs != null)
                    {
                        return lista_ALTA_MUEBLEs.Count;
                    }
                    else
                    {
                        return base_ALTA_MUEBLEs.Count;
                    }
                }
            }
        }
