...
{
    //internal partial class dald_H_PATRIMONIO_DEPENDIENTES : dal_H_PATRIMONIO_DEPENDIENTES
    //{
    ...
    //    internal dald_H_PATRIMONIO_DEPENDIENTES()
    //    : base() { }

    //    internal dald_H_PATRIMONIO_DEPENDIENTES(H_PATRIMONIO_DEPENDIENTES H_PATRIMONIO_DEPENDIENTES)
    //    : base(H_PATRIMONIO_DEPENDIENTES) { }

    //    internal dald_H_PATRIMONIO_DEPENDIENTES(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_DEPENDIENTE)
    //    : base(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_DEPENDIENTE) { }

    //    public dald_H_PATRIMONIO_DEPENDIENTES(String VID_NOMBRE, String VID_FECHA, String VID_HOMOCLAVE, Int32 NID_DEPENDIENTE, Int32 NID_TIPO_DEPENDIENTE, String E_NOMBRE, String E_PRIMER_A, String E_SEGUNDO_A, DateTime F_NACIMIENTO, String E_RFC, Int32 NID_HISTORICO, ExistingPrimaryKeyException.ExistingPrimaryKeyConditions lOpcionesRegistroExistente)
    //    : base(VID_NOMBRE, VID_FECHA, VID_HOMOCLAVE, NID_DEPENDIENTE, NID_TIPO_DEPENDIENTE, E_NOMBRE, E_PRIMER_A, E_SEGUNDO_A, F_NACIMIENTO, E_RFC, NID_HISTORICO, lOpcionesRegistroExistente)  { }
