...
{
    internal class dald__l_CAT_TITULAR : dal__l_CAT_TITULAR
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_TITULARs != null)
                    {
                        return lista_CAT_TITULARs.Count;
                    }
                    else
                    {
                        return base_CAT_TITULARs.Count;
                    }
                }
            }
        }
