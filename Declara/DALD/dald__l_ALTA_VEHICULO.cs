...
{
    internal class dald__l_ALTA_VEHICULO : dal__l_ALTA_VEHICULO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_ALTA_VEHICULOs != null)
                    {
                        return lista_ALTA_VEHICULOs.Count;
                    }
                    else
                    {
                        return base_ALTA_VEHICULOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_ALTA_VEHICULO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
