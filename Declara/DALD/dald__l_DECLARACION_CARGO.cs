...
{
    internal class dald__l_DECLARACION_CARGO : dal__l_DECLARACION_CARGO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_DECLARACION_CARGOs != null)
                    {
                        return lista_DECLARACION_CARGOs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_CARGOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_DECLARACION_CARGO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
