...
{
    internal class dald__l_CAT_DESGLOSE_INGRESO_SUPERIOR : dal__l_CAT_DESGLOSE_INGRESO_SUPERIOR
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_DESGLOSE_INGRESO_SUPERIORs != null)
                    {
                        return lista_CAT_DESGLOSE_INGRESO_SUPERIORs.Count;
                    }
                    else
                    {
                        return base_CAT_DESGLOSE_INGRESO_SUPERIORs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_CAT_DESGLOSE_INGRESO_SUPERIOR()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_CAT_DESGLOSE_INGRESO_SUPERIORs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_DESGLOSE_INGRESO_SUPERIORs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
