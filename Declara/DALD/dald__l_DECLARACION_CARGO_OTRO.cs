...
{
    internal class dald__l_DECLARACION_CARGO_OTRO : dal__l_DECLARACION_CARGO_OTRO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_DECLARACION_CARGO_OTROs != null)
                    {
                        return lista_DECLARACION_CARGO_OTROs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_CARGO_OTROs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_DECLARACION_CARGO_OTRO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_DECLARACION_CARGO_OTROs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_CARGO_OTROs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
