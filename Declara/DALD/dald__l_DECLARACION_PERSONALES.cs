...
{
    internal class dald__l_DECLARACION_PERSONALES : dal__l_DECLARACION_PERSONALES
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_DECLARACION_PERSONALESs != null)
                    {
                        return lista_DECLARACION_PERSONALESs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_PERSONALESs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_DECLARACION_PERSONALES()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_DECLARACION_PERSONALESs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_PERSONALESs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
