...
{
    internal class dald__l_USUARIO_DOMICILIO : dal__l_USUARIO_DOMICILIO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_USUARIO_DOMICILIOs != null)
                    {
                        return lista_USUARIO_DOMICILIOs.Count;
                    }
                    else
                    {
                        return base_USUARIO_DOMICILIOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_USUARIO_DOMICILIO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
