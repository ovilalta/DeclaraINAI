...
{
    internal class dald__l_MODIFICACION_TARJETA : dal__l_MODIFICACION_TARJETA
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_TARJETAs != null)
                    {
                        return lista_MODIFICACION_TARJETAs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_TARJETAs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_TARJETA()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_TARJETAs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_MODIFICACION_TARJETAs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
