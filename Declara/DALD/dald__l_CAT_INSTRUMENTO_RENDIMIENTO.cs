...
{
    internal class dald__l_CAT_INSTRUMENTO_RENDIMIENTO : dal__l_CAT_INSTRUMENTO_RENDIMIENTO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_INSTRUMENTO_RENDIMIENTOs != null)
                    {
                        return lista_CAT_INSTRUMENTO_RENDIMIENTOs.Count;
                    }
                    else
                    {
                        return base_CAT_INSTRUMENTO_RENDIMIENTOs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_CAT_INSTRUMENTO_RENDIMIENTO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_CAT_INSTRUMENTO_RENDIMIENTOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_INSTRUMENTO_RENDIMIENTOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
