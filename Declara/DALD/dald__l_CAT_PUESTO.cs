...
{
    internal class dald__l_CAT_PUESTO : dal__l_CAT_PUESTO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_PUESTOs != null)
                    {
                        return lista_CAT_PUESTOs.Count;
                    }
                    else
                    {
                        return base_CAT_PUESTOs.Count;
                    }
                }
            }
        }
