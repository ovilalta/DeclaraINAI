...
{
    internal class dald__l_MODIFICACION : dal__l_MODIFICACION
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACIONs != null)
                    {
                        return lista_MODIFICACIONs.Count;
                    }
                    else
                    {
                        return base_MODIFICACIONs.Count;
                    }
                }
            }
        }
