...
{
    internal class dald__l_CAT_SUBTIPO_INVERSION : dal__l_CAT_SUBTIPO_INVERSION
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_SUBTIPO_INVERSIONs != null)
                    {
                        return lista_CAT_SUBTIPO_INVERSIONs.Count;
                    }
                    else
                    {
                        return base_CAT_SUBTIPO_INVERSIONs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_SUBTIPO_INVERSION()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_SUBTIPO_INVERSIONs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_SUBTIPO_INVERSIONs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
