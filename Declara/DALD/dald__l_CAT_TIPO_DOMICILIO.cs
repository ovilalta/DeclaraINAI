...
{
    internal class dald__l_CAT_TIPO_DOMICILIO : dal__l_CAT_TIPO_DOMICILIO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_TIPO_DOMICILIOs != null)
                    {
                        return lista_CAT_TIPO_DOMICILIOs.Count;
                    }
                    else
                    {
                        return base_CAT_TIPO_DOMICILIOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_TIPO_DOMICILIO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_TIPO_DOMICILIOs = null;
            base.Single_Select();
            base.Single_Where();
