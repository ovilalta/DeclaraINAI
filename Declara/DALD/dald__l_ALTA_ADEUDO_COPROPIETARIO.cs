...
{
    internal class dald__l_ALTA_ADEUDO_COPROPIETARIO : dal__l_ALTA_ADEUDO_COPROPIETARIO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_ALTA_ADEUDO_COPROPIETARIOs != null)
                    {
                        return lista_ALTA_ADEUDO_COPROPIETARIOs.Count;
                    }
                    else
                    {
                        return base_ALTA_ADEUDO_COPROPIETARIOs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_ALTA_ADEUDO_COPROPIETARIO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_ALTA_ADEUDO_COPROPIETARIOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_ALTA_ADEUDO_COPROPIETARIOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
