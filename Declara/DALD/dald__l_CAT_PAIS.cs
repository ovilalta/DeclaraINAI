...
{
    internal class dald__l_CAT_PAIS : dal__l_CAT_PAIS
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_PAISs != null)
                    {
                        return lista_CAT_PAISs.Count;
                    }
                    else
                    {
                        return base_CAT_PAISs.Count;
                    }
                }
            }
        }
