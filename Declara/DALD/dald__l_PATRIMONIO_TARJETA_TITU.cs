...
{
  //  internal class dald__l_PATRIMONIO_TARJETA_TITU : dal__l_PATRIMONIO_TARJETA_TITU
  //  {
  ...
  //              else
  //              {
  //                  if (lista_PATRIMONIO_TARJETA_TITUs != null)
  //                  {
  //                      return lista_PATRIMONIO_TARJETA_TITUs.Count;
  //                  }
  //                  else
  //                  {
  //                      return base_PATRIMONIO_TARJETA_TITUs.Count;
  //                  }
  //              }
  //          }
  //      }
  ...
  //      internal dald__l_PATRIMONIO_TARJETA_TITU()
  //      : base()
  //      {
		//      _PageSize = 0;
  //          _PageNumber = 0;
  ...
  //      {
  //          query = null;
  //          lista_PATRIMONIO_TARJETA_TITUs = null;
  //          base.Single_Select();
  //          base.Single_Where();
  ...
  //      {
  //          single_query = null;
  //          base_PATRIMONIO_TARJETA_TITUs = null;
  //          base.Select();
  //          base.Where();
  //          WhereExtended();
  //          base.orderBy();
