...
{
    internal class dald__l_CAT_ESTADO_ESCOLARIDAD : dal__l_CAT_ESTADO_ESCOLARIDAD
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_ESTADO_ESCOLARIDADs != null)
                    {
                        return lista_CAT_ESTADO_ESCOLARIDADs.Count;
                    }
                    else
                    {
                        return base_CAT_ESTADO_ESCOLARIDADs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_CAT_ESTADO_ESCOLARIDAD()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_CAT_ESTADO_ESCOLARIDADs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_ESTADO_ESCOLARIDADs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
