...
{
    internal class dald__l_CAT_CONFLICTO_PREGUNTA : dal__l_CAT_CONFLICTO_PREGUNTA
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_CONFLICTO_PREGUNTAs != null)
                    {
                        return lista_CAT_CONFLICTO_PREGUNTAs.Count;
                    }
                    else
                    {
                        return base_CAT_CONFLICTO_PREGUNTAs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_CONFLICTO_PREGUNTA()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_CONFLICTO_PREGUNTAs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_CONFLICTO_PREGUNTAs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
