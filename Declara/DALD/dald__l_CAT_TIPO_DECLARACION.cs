...
{
    internal class dald__l_CAT_TIPO_DECLARACION : dal__l_CAT_TIPO_DECLARACION
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_TIPO_DECLARACIONs != null)
                    {
                        return lista_CAT_TIPO_DECLARACIONs.Count;
                    }
                    else
                    {
                        return base_CAT_TIPO_DECLARACIONs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_TIPO_DECLARACION()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_TIPO_DECLARACIONs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_TIPO_DECLARACIONs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
