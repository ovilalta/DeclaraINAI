...
{
    internal class dald__l_CAT_RELACION_TRANSMISOR : dal__l_CAT_RELACION_TRANSMISOR
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_RELACION_TRANSMISORs != null)
                    {
                        return lista_CAT_RELACION_TRANSMISORs.Count;
                    }
                    else
                    {
                        return base_CAT_RELACION_TRANSMISORs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_CAT_RELACION_TRANSMISOR()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_CAT_RELACION_TRANSMISORs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_RELACION_TRANSMISORs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
