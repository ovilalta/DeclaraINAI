...
{
    internal class dald__l_ALTA_INVERSION : dal__l_ALTA_INVERSION
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_ALTA_INVERSIONs != null)
                    {
                        return lista_ALTA_INVERSIONs.Count;
                    }
                    else
                    {
                        return base_ALTA_INVERSIONs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_ALTA_INVERSION()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
