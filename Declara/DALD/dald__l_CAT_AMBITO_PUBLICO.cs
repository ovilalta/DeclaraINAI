...
{
    internal class dald__l_CAT_AMBITO_PUBLICO : dal__l_CAT_AMBITO_PUBLICO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_AMBITO_PUBLICOs != null)
                    {
                        return lista_CAT_AMBITO_PUBLICOs.Count;
                    }
                    else
                    {
                        return base_CAT_AMBITO_PUBLICOs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_CAT_AMBITO_PUBLICO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_CAT_AMBITO_PUBLICOs = null;
            base.Single_Select();
            base.Single_Where();
