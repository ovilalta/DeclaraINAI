...
{
    internal class dald__l_MODIFICACION_INMUEBLE_TITULA : dal__l_MODIFICACION_INMUEBLE_TITULA
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_INMUEBLE_TITULAs != null)
                    {
                        return lista_MODIFICACION_INMUEBLE_TITULAs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_INMUEBLE_TITULAs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_INMUEBLE_TITULA()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_INMUEBLE_TITULAs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_MODIFICACION_INMUEBLE_TITULAs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
