...
{
    internal class dald__l_CAT_SECTOR : dal__l_CAT_SECTOR
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_SECTORs != null)
                    {
                        return lista_CAT_SECTORs.Count;
                    }
                    else
                    {
                        return base_CAT_SECTORs.Count;
                    }
                }
            }
        }
