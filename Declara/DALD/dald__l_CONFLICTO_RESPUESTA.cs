...
{
    internal class dald__l_CONFLICTO_RESPUESTA : dal__l_CONFLICTO_RESPUESTA
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CONFLICTO_RESPUESTAs != null)
                    {
                        return lista_CONFLICTO_RESPUESTAs.Count;
                    }
                    else
                    {
                        return base_CONFLICTO_RESPUESTAs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CONFLICTO_RESPUESTA()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CONFLICTO_RESPUESTAs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CONFLICTO_RESPUESTAs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
