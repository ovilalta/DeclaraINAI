...
{
    internal class dald__l_CONFLICTO : dal__l_CONFLICTO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CONFLICTOs != null)
                    {
                        return lista_CONFLICTOs.Count;
                    }
                    else
                    {
                        return base_CONFLICTOs.Count;
                    }
                }
            }
        }
