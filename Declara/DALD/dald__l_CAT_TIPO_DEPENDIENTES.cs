...
{
    internal class dald__l_CAT_TIPO_DEPENDIENTES : dal__l_CAT_TIPO_DEPENDIENTES
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_TIPO_DEPENDIENTESs != null)
                    {
                        return lista_CAT_TIPO_DEPENDIENTESs.Count;
                    }
                    else
                    {
                        return base_CAT_TIPO_DEPENDIENTESs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_TIPO_DEPENDIENTES()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_TIPO_DEPENDIENTESs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_TIPO_DEPENDIENTESs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
