...
{
    internal class dald__l_MODIFICACION_VEHICULO_TITU : dal__l_MODIFICACION_VEHICULO_TITU
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_VEHICULO_TITUs != null)
                    {
                        return lista_MODIFICACION_VEHICULO_TITUs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_VEHICULO_TITUs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_VEHICULO_TITU()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_VEHICULO_TITUs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_MODIFICACION_VEHICULO_TITUs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
