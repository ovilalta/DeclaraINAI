...
{
    internal class dald__l_ALTA_INMUEBLE : dal__l_ALTA_INMUEBLE
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_ALTA_INMUEBLEs != null)
                    {
                        return lista_ALTA_INMUEBLEs.Count;
                    }
                    else
                    {
                        return base_ALTA_INMUEBLEs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_ALTA_INMUEBLE()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
