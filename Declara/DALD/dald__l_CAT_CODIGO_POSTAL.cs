...
{
    internal class dald__l_CAT_CODIGO_POSTAL : dal__l_CAT_CODIGO_POSTAL
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_CODIGO_POSTALs != null)
                    {
                        return lista_CAT_CODIGO_POSTALs.Count;
                    }
                    else
                    {
                        return base_CAT_CODIGO_POSTALs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_CODIGO_POSTAL()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
