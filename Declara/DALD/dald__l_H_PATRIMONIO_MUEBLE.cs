...
{
    internal class dald__l_H_PATRIMONIO_MUEBLE : dal__l_H_PATRIMONIO_MUEBLE
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_H_PATRIMONIO_MUEBLEs != null)
                    {
                        return lista_H_PATRIMONIO_MUEBLEs.Count;
                    }
                    else
                    {
                        return base_H_PATRIMONIO_MUEBLEs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_H_PATRIMONIO_MUEBLE()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_H_PATRIMONIO_MUEBLEs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_H_PATRIMONIO_MUEBLEs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
