...
{
    internal class dald__l_DECLARACION_DEPENDIENTES_PRIVADO : dal__l_DECLARACION_DEPENDIENTES_PRIVADO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_DECLARACION_DEPENDIENTES_PRIVADOs != null)
                    {
                        return lista_DECLARACION_DEPENDIENTES_PRIVADOs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_DEPENDIENTES_PRIVADOs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_DECLARACION_DEPENDIENTES_PRIVADO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_DECLARACION_DEPENDIENTES_PRIVADOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_DEPENDIENTES_PRIVADOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
