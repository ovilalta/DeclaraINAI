...
{
    internal class dald__l_CAT_CONFLICTO_RUBRO : dal__l_CAT_CONFLICTO_RUBRO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_CONFLICTO_RUBROs != null)
                    {
                        return lista_CAT_CONFLICTO_RUBROs.Count;
                    }
                    else
                    {
                        return base_CAT_CONFLICTO_RUBROs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_CONFLICTO_RUBRO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_CONFLICTO_RUBROs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_CAT_CONFLICTO_RUBROs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
