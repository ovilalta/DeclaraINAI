...
{
    internal class dald__l_MODIFICACION_GASTO : dal__l_MODIFICACION_GASTO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_GASTOs != null)
                    {
                        return lista_MODIFICACION_GASTOs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_GASTOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_GASTO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_GASTOs = null;
            base.Single_Select();
            base.Single_Where();
