...
{
    internal class dald__l_CAT_MUNICIPIO : dal__l_CAT_MUNICIPIO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_MUNICIPIOs != null)
                    {
                        return lista_CAT_MUNICIPIOs.Count;
                    }
                    else
                    {
                        return base_CAT_MUNICIPIOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_MUNICIPIO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
