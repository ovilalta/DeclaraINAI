...
{
    internal class dald__l_ALTA_COMODATO_VEHICULO : dal__l_ALTA_COMODATO_VEHICULO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_ALTA_COMODATO_VEHICULOs != null)
                    {
                        return lista_ALTA_COMODATO_VEHICULOs.Count;
                    }
                    else
                    {
                        return base_ALTA_COMODATO_VEHICULOs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_ALTA_COMODATO_VEHICULO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_ALTA_COMODATO_VEHICULOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_ALTA_COMODATO_VEHICULOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
