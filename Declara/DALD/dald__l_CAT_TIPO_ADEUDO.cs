...
{
    internal class dald__l_CAT_TIPO_ADEUDO : dal__l_CAT_TIPO_ADEUDO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_TIPO_ADEUDOs != null)
                    {
                        return lista_CAT_TIPO_ADEUDOs.Count;
                    }
                    else
                    {
                        return base_CAT_TIPO_ADEUDOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_TIPO_ADEUDO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
