...
{
    internal class dald__l_PATRIMONIO_MUEBLE : dal__l_PATRIMONIO_MUEBLE
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_PATRIMONIO_MUEBLEs != null)
                    {
                        return lista_PATRIMONIO_MUEBLEs.Count;
                    }
                    else
                    {
                        return base_PATRIMONIO_MUEBLEs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_PATRIMONIO_MUEBLE()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
