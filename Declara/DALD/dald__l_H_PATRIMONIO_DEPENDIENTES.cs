...
{
  //  internal class dald__l_H_PATRIMONIO_DEPENDIENTES : dal__l_H_PATRIMONIO_DEPENDIENTES
  //  {
  ...
  //              else
  //              {
  //                  if (lista_H_PATRIMONIO_DEPENDIENTESs != null)
  //                  {
  //                      return lista_H_PATRIMONIO_DEPENDIENTESs.Count;
  //                  }
  //                  else
  //                  {
  //                      return base_H_PATRIMONIO_DEPENDIENTESs.Count;
  //                  }
  //              }
  //          }
  //      }
  ...
  //      internal dald__l_H_PATRIMONIO_DEPENDIENTES()
  //      : base()
  //      {
		//      _PageSize = 0;
  //          _PageNumber = 0;
  ...
  //      {
  //          query = null;
  //          lista_H_PATRIMONIO_DEPENDIENTESs = null;
  //          base.Single_Select();
  //          base.Single_Where();
  ...
  //      {
  //          single_query = null;
  //          base_H_PATRIMONIO_DEPENDIENTESs = null;
  //          base.Select();
  //          base.Where();
  //          WhereExtended();
  //          base.orderBy();
