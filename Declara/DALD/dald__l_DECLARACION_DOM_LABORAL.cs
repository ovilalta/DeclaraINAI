...
{
    internal class dald__l_DECLARACION_DOM_LABORAL : dal__l_DECLARACION_DOM_LABORAL
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_DECLARACION_DOM_LABORALs != null)
                    {
                        return lista_DECLARACION_DOM_LABORALs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_DOM_LABORALs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_DECLARACION_DOM_LABORAL()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_DECLARACION_DOM_LABORALs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_DOM_LABORALs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
