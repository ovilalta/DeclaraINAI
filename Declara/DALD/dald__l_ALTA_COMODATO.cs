...
{
    internal class dald__l_ALTA_COMODATO : dal__l_ALTA_COMODATO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_ALTA_COMODATOs != null)
                    {
                        return lista_ALTA_COMODATOs.Count;
                    }
                    else
                    {
                        return base_ALTA_COMODATOs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_ALTA_COMODATO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
