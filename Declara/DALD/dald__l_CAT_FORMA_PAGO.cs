...
{
    internal class dald__l_CAT_FORMA_PAGO : dal__l_CAT_FORMA_PAGO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_FORMA_PAGOs != null)
                    {
                        return lista_CAT_FORMA_PAGOs.Count;
                    }
                    else
                    {
                        return base_CAT_FORMA_PAGOs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_CAT_FORMA_PAGO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
