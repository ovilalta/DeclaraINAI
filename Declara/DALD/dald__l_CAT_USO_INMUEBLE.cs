...
{
    internal class dald__l_CAT_USO_INMUEBLE : dal__l_CAT_USO_INMUEBLE
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_USO_INMUEBLEs != null)
                    {
                        return lista_CAT_USO_INMUEBLEs.Count;
                    }
                    else
                    {
                        return base_CAT_USO_INMUEBLEs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_USO_INMUEBLE()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
