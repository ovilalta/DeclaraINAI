...
{
    internal class dald__l_MODIFICACION_VEHICULO_ADEU : dal__l_MODIFICACION_VEHICULO_ADEU
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_VEHICULO_ADEUs != null)
                    {
                        return lista_MODIFICACION_VEHICULO_ADEUs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_VEHICULO_ADEUs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_VEHICULO_ADEU()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_VEHICULO_ADEUs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_MODIFICACION_VEHICULO_ADEUs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
