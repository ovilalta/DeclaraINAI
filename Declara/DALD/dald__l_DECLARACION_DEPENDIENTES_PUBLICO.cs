...
{
    internal class dald__l_DECLARACION_DEPENDIENTES_PUBLICO : dal__l_DECLARACION_DEPENDIENTES_PUBLICO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_DECLARACION_DEPENDIENTES_PUBLICOs != null)
                    {
                        return lista_DECLARACION_DEPENDIENTES_PUBLICOs.Count;
                    }
                    else
                    {
                        return base_DECLARACION_DEPENDIENTES_PUBLICOs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_DECLARACION_DEPENDIENTES_PUBLICO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_DECLARACION_DEPENDIENTES_PUBLICOs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_DECLARACION_DEPENDIENTES_PUBLICOs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
