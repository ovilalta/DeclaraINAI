...
{
    internal class dald__l_CAT_ESTADO_TESTADO : dal__l_CAT_ESTADO_TESTADO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_ESTADO_TESTADOs != null)
                    {
                        return lista_CAT_ESTADO_TESTADOs.Count;
                    }
                    else
                    {
                        return base_CAT_ESTADO_TESTADOs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_CAT_ESTADO_TESTADO()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_CAT_ESTADO_TESTADOs = null;
            base.Single_Select();
            base.Single_Where();
