...
{
    internal class dald__l_USUARIO_SESION : dal__l_USUARIO_SESION
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_USUARIO_SESIONs != null)
                    {
                        return lista_USUARIO_SESIONs.Count;
                    }
                    else
                    {
                        return base_USUARIO_SESIONs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_USUARIO_SESION()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
