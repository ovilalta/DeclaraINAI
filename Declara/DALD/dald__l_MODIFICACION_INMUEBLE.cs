...
{
    internal class dald__l_MODIFICACION_INMUEBLE : dal__l_MODIFICACION_INMUEBLE
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_INMUEBLEs != null)
                    {
                        return lista_MODIFICACION_INMUEBLEs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_INMUEBLEs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_INMUEBLE()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_INMUEBLEs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_MODIFICACION_INMUEBLEs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
