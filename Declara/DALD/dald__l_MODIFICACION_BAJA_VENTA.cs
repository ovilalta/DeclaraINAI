...
{
    internal class dald__l_MODIFICACION_BAJA_VENTA : dal__l_MODIFICACION_BAJA_VENTA
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_MODIFICACION_BAJA_VENTAs != null)
                    {
                        return lista_MODIFICACION_BAJA_VENTAs.Count;
                    }
                    else
                    {
                        return base_MODIFICACION_BAJA_VENTAs.Count;
                    }
                }
            }
        }
     ...
     #region *** Constructores ***
        ...
        internal dald__l_MODIFICACION_BAJA_VENTA()
        : base()
        {
		      _PageSize = 0;
            _PageNumber = 0;
  ...
  private void Single_WhereExtended()
        ...
        {
            query = null;
            lista_MODIFICACION_BAJA_VENTAs = null;
            base.Single_Select();
            base.Single_Where();
        ...
        {
            single_query = null;
            base_MODIFICACION_BAJA_VENTAs = null;
            base.Select();
            base.Where();
            WhereExtended();
            base.orderBy();
