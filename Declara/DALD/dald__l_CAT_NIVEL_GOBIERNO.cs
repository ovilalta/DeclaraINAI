...
{
    internal class dald__l_CAT_NIVEL_GOBIERNO : dal__l_CAT_NIVEL_GOBIERNO
    {
        ...
        internal Int32 TotalItems
        {
            get
            {
                ...
                {
                    if (lista_CAT_NIVEL_GOBIERNOs != null)
                    {
                        return lista_CAT_NIVEL_GOBIERNOs.Count;
                    }
                    else
                    {
                        return base_CAT_NIVEL_GOBIERNOs.Count;
                    }
                }
            }
        }
        ...
        internal dald__l_CAT_NIVEL_GOBIERNO()
        : base()
        {
            _PageSize = 0;
            _PageNumber = 0;
        ...
        {
            query = null;
            lista_CAT_NIVEL_GOBIERNOs = null;
            base.Single_Select();
            base.Single_Where();
