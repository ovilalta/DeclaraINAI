...
{
    internal class dald__l_CAT_APARTADO : dal__l_CAT_APARTADO
    {
    ...
    internal Int32 TotalItems
        {
            get 
            {
                ...
                {
                    if (lista_CAT_APARTADOs != null)
                    {
                        return lista_CAT_APARTADOs.Count;
                    }
                    else
                    {
                        return base_CAT_APARTADOs.Count;
                    }
                }
            }
        }
