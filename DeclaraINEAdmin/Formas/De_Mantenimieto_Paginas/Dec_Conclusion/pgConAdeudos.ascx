<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pgConAdeudos.ascx.cs" Inherits="DeclaraINEAdmin.Formas.De_Mantenimieto_Paginas.Dec_Conclusion.pgConAdeudos" %>
