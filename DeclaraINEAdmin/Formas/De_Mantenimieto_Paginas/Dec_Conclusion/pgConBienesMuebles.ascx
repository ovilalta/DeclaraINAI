<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pgConBienesMuebles.ascx.cs" Inherits="DeclaraINEAdmin.Formas.De_Mantenimieto_Paginas.Dec_Conclusion.pgConBienesMuebles" %>
