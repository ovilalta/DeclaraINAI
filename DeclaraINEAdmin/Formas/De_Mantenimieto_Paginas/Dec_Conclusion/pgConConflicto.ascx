<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pgConConflicto.ascx.cs" Inherits="DeclaraINEAdmin.Formas.De_Mantenimieto_Paginas.Dec_Conclusion.pgConConflicto" %>
    ...
    <Columns>
        <asp:TemplateField HeaderText="En este sentido:">
            <ItemTemplate>
                ...
                <br />
                <asp:Panel runat="server" ID="panel" ClientIDMode="Static" CssClass="right" Visible='<%# Eval("L_ENCABEZADOS") %>'>
