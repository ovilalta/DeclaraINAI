<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BienesVehiculos.ascx.cs" Inherits="DeclaraINEAdmin.Formas.De_Mantenimieto_Paginas.Dec_Inicio.BienesVehiculos" %>
<asp:GridView runat="server" OnRowDataBound="grdVehiculos_RowDataBound" AutoGenerateColumns="false" ID="grdVehiculos"  CssClass="table table-condensed table-striped table-hover alanGrid-theme">
    <Columns>
