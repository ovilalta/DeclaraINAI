<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pgModDGConyuge.ascx.cs" Inherits="DeclaraINEAdmin.Formas.De_Mantenimieto_Paginas.Dec_Modificacion.pgModDGConyuge" %>
