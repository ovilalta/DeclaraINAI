<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pgModBienesVehiculos.ascx.cs" Inherits="DeclaraINEAdmin.Formas.De_Mantenimieto_Paginas.Dec_Modificacion.pgModBienesVehiculos" %>
