<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pgModBienesInmuebles.ascx.cs" Inherits="DeclaraINEAdmin.Formas.De_Mantenimieto_Paginas.Dec_Modificacion.pgModBienesInmuebles" %>
