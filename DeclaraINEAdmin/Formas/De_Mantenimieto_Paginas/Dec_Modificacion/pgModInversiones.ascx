<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pgModInversiones.ascx.cs" Inherits="DeclaraINEAdmin.Formas.De_Mantenimieto_Paginas.Dec_Modificacion.pgModInversiones" %>
