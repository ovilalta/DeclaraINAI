<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="M_Conyugue.ascx.cs" Inherits="DeclaraINEAdmin.Formas.De_Mantenimieto_Paginas.M_Conyugue" %>
...
<asp:GridView ID="grdDEP" CssClass="table table-condensed table-striped table-hover alanGrid-theme" runat="server" AutoGenerateColumns="false">
    <Columns>
        ...
        <asp:TemplateField HeaderText="Parentesco">
            <ItemTemplate>
                <asp:Image ID="imgParentesco" width="24px" Height="24px" imgurl='<%# string.Concat("~/Images/CAT_TIPO_DEPENDIENTE/", Eval("NID_TIPO_DEPENDIENTE") , ".png")%>' runat="server" />
